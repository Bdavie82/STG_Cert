...
#
# Last update: Sun Jul  1 12:22:14 2018
...
try:
    ...
    r(b'DRFSObject', b'propertiesForFilesystem:mergeWithOtherFilesystems:', {'arguments': {3: {'type': b'Z'}}})
    r(b'DRFSObject', b'propertyForKey:inFilesystem:mergeWithOtherFilesystems:', {'arguments': {4: {'type': b'Z'}}})
    r(b'DRMSF', b'isEqualToMSF:', {'retval': {'type': b'Z'}})
    r(b'NSObject', b'calculateSizeOfFile:fork:estimating:', {'required': True, 'retval': {'type': b'Q'}, 'arguments': {2: {'type': b'@'}, 3: {'type': sel32or64(b'L', b'I')}, 4: {'type': b'Z'}}})
    r(b'NSObject', b'cleanupFileAfterBurn:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'cleanupTrackAfterBurn:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'cleanupTrackAfterVerification:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'estimateLengthOfTrack:', {'required': True, 'retval': {'type': b'Q'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'prepareFileForBurn:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'prepareFileForVerification:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'prepareTrack:forBurn:toMedia:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'prepareTrackForVerification:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'produceDataForTrack:intoBuffer:length:atAddress:blockSize:ioFlags:', {'required': True, 'retval': {'type': b'I'}, 'arguments': {2: {'type': b'@'}, 3: {'type': '^v', 'type_modifier': b'o', 'c_array_length_in_arg': 4}, 4: {'type': b'I'}, 5: {'type': b'Q'}, 6: {'type': b'I'}, 7: {'type': b'^I', 'type_modifier': b'N'}}})
    r(b'NSObject', b'produceFile:fork:intoBuffer:length:atAddress:blockSize:', {'required': True, 'retval': {'type': b'I'}, 'arguments': {2: {'type': b'@'}, 3: {'type': sel32or64(b'L', b'I')}, 4: {'type': '^v', 'type_modifier': b'o', 'c_array_length_in_arg': 5}, 5: {'type': b'I'}, 6: {'type': b'Q'}, 7: {'type': b'I'}}})
    r(b'NSObject', b'producePreGapForTrack:intoBuffer:length:atAddress:blockSize:ioFlags:', {'required': True, 'retval': {'type': b'I'}, 'arguments': {2: {'type': b'@'}, 3: {'type': '^v', 'type_modifier': b'o', 'c_array_length_in_arg': 4}, 4: {'type': b'I'}, 5: {'type': b'Q'}, 6: {'type': b'I'}, 7: {'type': b'^I', 'type_modifier': b'N'}}})
    r(b'NSObject', b'verifyDataForTrack:inBuffer:length:atAddress:blockSize:ioFlags:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 4}, 4: {'type': b'I'}, 5: {'type': b'Q'}, 6: {'type': b'I'}, 7: {'type': b'^I', 'type_modifier': b'N'}}})
    r(b'NSObject', b'verifyPreGapForTrack:inBuffer:length:atAddress:blockSize:ioFlags:', {'required': True, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 4}, 4: {'type': b'I'}, 5: {'type': b'Q'}, 6: {'type': b'I'}, 7: {'type': b'^I', 'type_modifier': b'N'}}})
finally:
