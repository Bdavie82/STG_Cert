...
#
# Last update: Mon Aug 10 11:23:16 2015
...
misc.update({'QTTimeRange': objc.createStructType('QTTimeRange', sel32or64(b'{_QTTimeRange={_QTTime=qll}{_QTTime=qll}}', b'{_QTTimeRange={_QTTime=qqq}{_QTTime=qqq}}'), ['time', 'duration']), 'QTTime': objc.createStructType('QTTime', sel32or64(b'{_QTTime=qll}', b'{_QTTime=qqq}'), ['timeValue', 'timeScale', 'flags'])})
...
try:
    ...
    r(b'QTTrack', b'insertSegmentOfTrack:fromRange:scaledToRange:', {'arguments': {3: {'type': sel32or64(b'{_QTTimeRange={_QTTime=qll}{_QTTime=qll}}', b'{_QTTimeRange={_QTTime=qqq}{_QTTime=qqq}}')}, 4: {'type': sel32or64(b'{_QTTimeRange={_QTTime=qll}{_QTTime=qll}}', b'{_QTTimeRange={_QTTime=qqq}{_QTTime=qqq}}')}}})
    r(b'QTTrack', b'insertSegmentOfTrack:timeRange:atTime:', {'arguments': {3: {'type': sel32or64(b'{_QTTimeRange={_QTTime=qll}{_QTTime=qll}}', b'{_QTTimeRange={_QTTime=qqq}{_QTTime=qqq}}')}, 4: {'type': sel32or64(b'{_QTTime=qll}', b'{_QTTime=qqq}')}}})
    r(b'QTTrack', b'isEnabled', {'retval': {'type': 'Z'}})
    r(b'QTTrack', b'scaleSegment:newDuration:', {'arguments': {2: {'type': sel32or64(b'{_QTTimeRange={_QTTime=qll}{_QTTime=qll}}', b'{_QTTimeRange={_QTTime=qqq}{_QTTime=qqq}}')}, 3: {'type': sel32or64(b'{_QTTime=qll}', b'{_QTTime=qqq}')}}})
    r(b'QTTrack', b'setEnabled:', {'arguments': {2: {'type': 'Z'}}})
finally:
    objc._updatingMetadata(False)
r = objc.registerMetaDataForSelector
objc._updatingMetadata(True)
try:
    r(b'NSObject', b'captureOutput:didDropVideoFrameWithSampleBuffer:fromConnection:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'captureOutput:didFinishRecordingToOutputFileAtURL:forConnections:dueToError:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'captureOutput:didOutputAudioSampleBuffer:fromConnection:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'captureOutput:didOutputSampleBuffer:fromConnection:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'captureOutput:didOutputVideoFrame:withSampleBuffer:fromConnection:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^{__CVBuffer=}'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'captureOutput:didOutputVideoFrame:withSampleBuffer:fromConnection:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'^{__CVBuffer=}'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'captureOutput:didPauseRecordingToOutputFileAtURL:forConnections:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'captureOutput:didResumeRecordingToOutputFileAtURL:forConnections:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'captureOutput:didStartRecordingToOutputFileAtURL:forConnections:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'captureOutput:mustChangeOutputFileAtURL:forConnections:dueToError:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'captureOutput:shouldChangeOutputFileAtURL:forConnections:dueToError:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'captureOutput:willFinishRecordingToOutputFileAtURL:forConnections:dueToError:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'captureOutput:willStartRecordingToOutputFileAtURL:forConnections:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'delegate', {'retval': {'type': b'@'}})
    r(b'NSObject', b'menuForEventDelegate:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'setDelegate:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'view:willDisplayImage:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'view:willDisplayImage:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
finally:
    objc._updatingMetadata(False)
protocols={'QTCaptureDecompressedVideoOutput_Delegate': objc.informal_protocol('QTCaptureDecompressedVideoOutput_Delegate', [objc.selector(None, b'captureOutput:didOutputVideoFrame:withSampleBuffer:fromConnection:', b'v@:@^{__CVBuffer=}@@', isRequired=False), objc.selector(None, b'captureOutput:didDropVideoFrameWithSampleBuffer:fromConnection:', b'v@:@@@', isRequired=False)]), 'QTMovieView_Delegate': objc.informal_protocol('QTMovieView_Delegate', [objc.selector(None, b'view:willDisplayImage:', b'@@:@@', isRequired=False), objc.selector(None, b'menuForEventDelegate:', b'@@:@', isRequired=False)]), 'QTCaptureVideoPreviewOutput_Delegate': objc.informal_protocol('QTCaptureVideoPreviewOutput_Delegate', [objc.selector(None, b'captureOutput:didOutputVideoFrame:withSampleBuffer:fromConnection:', b'v@:@^{__CVBuffer=}@@', isRequired=False)]), 'QTCaptureView_Delegate': objc.informal_protocol('QTCaptureView_Delegate', [objc.selector(None, b'view:willDisplayImage:', b'@@:@@', isRequired=False)]), 'QTCaptureDecompressedAudioOutput_Delegate': objc.informal_protocol('QTCaptureDecompressedAudioOutput_Delegate', [objc.selector(None, b'captureOutput:didOutputAudioSampleBuffer:fromConnection:', b'v@:@@@', isRequired=False)]), 'QTCaptureFileOutput_Delegate': objc.informal_protocol('QTCaptureFileOutput_Delegate', [objc.selector(None, b'captureOutput:didOutputSampleBuffer:fromConnection:', b'v@:@@@', isRequired=False), objc.selector(None, b'captureOutput:didResumeRecordingToOutputFileAtURL:forConnections:', b'v@:@@@', isRequired=False), objc.selector(None, b'captureOutput:shouldChangeOutputFileAtURL:forConnections:dueToError:', b'Z@:@@@@', isRequired=False), objc.selector(None, b'captureOutput:didStartRecordingToOutputFileAtURL:forConnections:', b'v@:@@@', isRequired=False), objc.selector(None, b'captureOutput:willFinishRecordingToOutputFileAtURL:forConnections:dueToError:', b'v@:@@@@', isRequired=False), objc.selector(None, b'captureOutput:didPauseRecordingToOutputFileAtURL:forConnections:', b'v@:@@@', isRequired=False), objc.selector(None, b'captureOutput:mustChangeOutputFileAtURL:forConnections:dueToError:', b'v@:@@@@', isRequired=False), objc.selector(None, b'captureOutput:didFinishRecordingToOutputFileAtURL:forConnections:dueToError:', b'v@:@@@@', isRequired=False), objc.selector(None, b'captureOutput:willStartRecordingToOutputFileAtURL:forConnections:', b'v@:@@@', isRequired=False)]), 'QTMovie_Delegate': objc.informal_protocol('QTMovie_Delegate', [objc.selector(None, b'setDelegate:', b'v@:@', isRequired=False), objc.selector(None, b'delegate', b'@@:', isRequired=False)])}
expressions = {}
