...
#
# Last update: Sun May 22 16:51:31 2016
...
misc.update({'ProcessInfoExtendedRec': objc.createStructType('ProcessInfoExtendedRec', sel32or64(b'{ProcessInfoExtendedRec=L^C{ProcessSerialNumber=LL}LLL^cLL{ProcessSerialNumber=LL}LL^{FSSpec=sl[64C]}LL}', b'{ProcessInfoExtendedRec=I^C{ProcessSerialNumber=II}III^cII{ProcessSerialNumber=II}II^{FSRef=[80C]}II}'), ['processInfoLength', 'processName', 'processNumber', 'processType', 'processSignature', 'processMode', 'processLocation', 'processSize', 'processFreeMem', 'processLauncher', 'processLaunchDate', 'processActiveTime', 'processAppSpec', 'processTempMemTotal', 'processPurgeableTempMemTotal']), 'ProcessInfoRec': objc.createStructType('ProcessInfoRec', sel32or64(b'{ProcessInfoRec=L^C{ProcessSerialNumber=LL}LLL^cLL{ProcessSerialNumber=LL}LL^{FSSpec=sl[64C]}}', b'{ProcessInfoRec=I^C{ProcessSerialNumber=II}III^cII{ProcessSerialNumber=II}II^{FSRef=[80C]}}'), ['processInfoLength', 'processName', 'processNumber', 'processType', 'processSignature', 'processMode', 'processLocation', 'processSize', 'processFreeMem', 'processLauncher', 'processLaunchDate', 'processActiveTime', 'processAppSpec']), 'LaunchParamBlockRec': objc.createStructType('LaunchParamBlockRec', sel32or64(b'{LaunchParamBlockRec=LSSLSS^{FSSpec=sl[64C]}{ProcessSerialNumber=LL}LLL^{AppParameters={_struct AppParameters::<anonymous at /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk/System/Library/Frameworks/ApplicationServices.framework/Frameworks/HIServices.framework/Headers/Processes.h:57:3>=SLL{Point=ss}S}{=SLL{Point=ss}S}LL}}', b'{LaunchParamBlockRec=ISSISS^{FSRef=[80C]}{ProcessSerialNumber=II}III^{AppParameters={_struct AppParameters::<anonymous at /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk/System/Library/Frameworks/ApplicationServices.framework/Frameworks/HIServices.framework/Headers/Processes.h:57:3>=SII{Point=ss}S}{=SII{Point=ss}S}II}}'), ['reserved1', 'reserved2', 'launchBlockID', 'launchEPBLength', 'launchFileFlags', 'launchControlFlags', 'launchAppSpec', 'launchProcessSN', 'launchPreferredSize', 'launchMinimumSize', 'launchAvailableSize', 'launchAppParameters']), 'SizeResourceRec': objc.createStructType('SizeResourceRec', sel32or64(b'{SizeResourceRec=SLL}', b'{SizeResourceRec=SII}'), ['flags', 'preferredHeapSize', 'minimumHeapSize']), 'CIcon': objc.createStructType('CIcon', b'{CIcon={PixMap=^cs{Rect=ssss}sslllssssL^^{ColorTable=lss[1{ColorSpec=s{RGBColor=SSS}}]}^v}{BitMap=^cs{Rect=ssss}}{BitMap=^cs{Rect=ssss}}^^c[1s]}', ['iconPMap', 'iconMask', 'iconBMap', 'iconData', 'iconMaskData']), 'AppParameters': objc.createStructType('AppParameters', sel32or64(b'{AppParameters={_struct AppParameters::<anonymous at /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk/System/Library/Frameworks/ApplicationServices.framework/Frameworks/HIServices.framework/Headers/Processes.h:57:3>=SLL{Point=ss}S}{=SLL{Point=ss}S}LL}', b'{AppParameters={_struct AppParameters::<anonymous at /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.10.sdk/System/Library/Frameworks/ApplicationServices.framework/Frameworks/HIServices.framework/Headers/Processes.h:57:3>=SII{Point=ss}S}{=SII{Point=ss}S}II}'), ['theMsgEvent', 'eventRefCon', 'messageLength'])})
