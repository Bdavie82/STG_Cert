...
#
# Last update: Tue Jun  5 20:21:27 2018
...
misc.update({'NSUndefinedDateComponent': sel32or64(2147483647, 9223372036854775807), 'NSDateComponentUndefined': sel32or64(2147483647, 9223372036854775807), 'NSMaximumStringLength': sel32or64(2147483647, 9223372036854775807), 'NSNotFound': sel32or64(2147483647, 9223372036854775807)})
...
try:
    ...
    r(b'NSAppleEventDescriptor', b'aeDesc', {'retval': {'type': 'r^{AEDesc=I^^{OpaqueAEDataStorageType}}'}})
    r(b'NSAppleEventDescriptor', b'booleanValue', {'retval': {'type': 'Z'}})
    r(b'NSAppleEventDescriptor', b'descriptorWithBoolean:', {'arguments': {2: {'type': 'Z'}}})
    ...
    r(b'NSAppleEventDescriptor', b'dispatchRawAppleEvent:withRawReply:handlerRefCon:', {'retval': {'type': 's'}, 'arguments': {4: {'type': 'l'}}})
    r(b'NSAppleEventDescriptor', b'initWithAEDescNoCopy:', {'arguments': {2: {'type': 'r^{AEDesc=I^^{OpaqueAEDataStorageType}}', 'type_modifier': b'n'}}})
    ...
    r(b'NSAppleEventManager', b'dispatchRawAppleEvent:withRawReply:handlerRefCon:', {'arguments': {2: {'type': 'r^{AEDesc=I^^{OpaqueAEDataStorageType}}', 'type_modifier': b'n'}, 3: {'type': 'r^{AEDesc=I^^{OpaqueAEDataStorageType}}', 'type_modifier': b'o'}}})
    r(b'NSAppleEventManager', b'setEventHandler:andSelector:forEventClass:andEventID:', {'arguments': {3: {'sel_of_type': b'v@:@@'}}})
    r(b'NSAppleScript', b'compileAndReturnError:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type_modifier': b'o'}}})
    ...
    r(b'NSArray', b'addObserver:forKeyPath:options:context:', {'arguments': {5: {'type': '^v'}}})
    r(b'NSArray', b'addObserver:toObjectsAtIndexes:forKeyPath:options:context:', {'arguments': {6: {'type': '^v'}}})
    r(b'NSArray', b'arrayWithContentsOfURL:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    ...
    r(b'NSArray', b'enumerateObjectsAtIndexes:options:usingBlock:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSArray', b'enumerateObjectsUsingBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSArray', b'enumerateObjectsWithOptions:usingBlock:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSArray', b'getObjects:', {'arguments': {2: {'type': '^@'}}, 'suggestion': 'convert to Python list instead'})
    r(b'NSArray', b'getObjects:range:', {'retval': {'type': 'v'}, 'arguments': {2: {'type_modifier': b'o', 'c_array_length_in_arg': 3}, 3: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSArray', b'indexOfObject:inRange:', {'arguments': {3: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSArray', b'indexOfObject:inSortedRange:options:usingComparator:', {'arguments': {5: {'callable': {'retval': {'type': b'l'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSArray', b'indexOfObjectAtIndexes:options:passingTest:', {'arguments': {4: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSArray', b'indexOfObjectIdenticalTo:inRange:', {'arguments': {3: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSArray', b'indexOfObjectPassingTest:', {'arguments': {2: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSArray', b'indexOfObjectWithOptions:passingTest:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSArray', b'indexesOfObjectsAtIndexes:options:passingTest:', {'arguments': {4: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSArray', b'indexesOfObjectsPassingTest:', {'arguments': {2: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSArray', b'indexesOfObjectsWithOptions:passingTest:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSArray', b'initWithArray:copyItems:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSArray', b'initWithContentsOfURL:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    ...
    r(b'NSArray', b'sortedArrayUsingComparator:', {'arguments': {2: {'callable': {'retval': {'type': b'l'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSArray', b'sortedArrayUsingFunction:context:', {'arguments': {2: {'callable': {'retval': {'type': b'l'}, 'arguments': {0: {'type': b'@'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}, 'callable_retained': False}, 3: {'type': '@'}}})
    r(b'NSArray', b'sortedArrayUsingFunction:context:hint:', {'arguments': {2: {'callable': {'retval': {'type': b'l'}, 'arguments': {0: {'type': b'@'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}, 'callable_retained': False}, 3: {'type': '@'}}})
    r(b'NSArray', b'sortedArrayUsingSelector:', {'arguments': {2: {'sel_of_type': b'i@:@'}}})
    r(b'NSArray', b'sortedArrayWithOptions:usingComparator:', {'arguments': {3: {'callable': {'retval': {'type': b'l'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSArray', b'subarrayWithRange:', {'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSArray', b'writeToFile:atomically:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': 'Z'}}})
    r(b'NSArray', b'writeToURL:atomically:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': 'Z'}}})
    r(b'NSArray', b'writeToURL:error:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSAssertionHandler', b'handleFailureInFunction:file:lineNumber:description:', {'arguments': {5: {'printf_format': True, 'type': '@'}}, 'variadic': True})
    r(b'NSAssertionHandler', b'handleFailureInMethod:object:file:lineNumber:description:', {'arguments': {2: {'type': ':'}, 6: {'printf_format': True, 'type': '@'}}, 'variadic': True})
    ...
    r(b'NSAttributedString', b'enumerateAttribute:inRange:options:usingBlock:', {'arguments': {5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSAttributedString', b'enumerateAttributesInRange:options:usingBlock:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    ...
    r(b'NSBackgroundActivityScheduler', b'scheduleWithBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'i', b'q')}}}}}})
    r(b'NSBackgroundActivityScheduler', b'setRepeats:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSBackgroundActivityScheduler', b'shouldDefer', {'retval': {'type': b'Z'}})
    r(b'NSBlockOperation', b'addExecutionBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'NSBlockOperation', b'blockOperationWithBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'NSBundle', b'isLoaded', {'retval': {'type': 'Z'}})
    r(b'NSBundle', b'load', {'retval': {'type': 'Z'}})
    r(b'NSBundle', b'loadAndReturnError:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type_modifier': b'o'}}})
    r(b'NSBundle', b'preflightAndReturnError:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type_modifier': b'o'}}})
    ...
    r(b'NSByteCountFormatter', b'setAllowsNonnumericFormatting:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSByteCountFormatter', b'setIncludesActualByteCount:', {'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'NSByteCountFormatter', b'setZeroPadsFractionDigits:', {'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'NSCache', b'setEvictsObjectsWithDiscardedContent:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSCalendar', b'date:matchesComponents:', {'retval': {'type': b'Z'}})
    r(b'NSCalendar', b'enumerateDatesStartingAfterDate:matchingComponents:options:usingBlock:', {'arguments': {5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'Z'}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    ...
    r(b'NSCalendar', b'nextWeekendStartDate:interval:options:afterDate:', {'retval': {'type': b'Z'}})
    r(b'NSCalendar', b'rangeOfUnit:inUnit:forDate:', {'retval': {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}})
    r(b'NSCalendar', b'rangeOfUnit:startDate:interval:forDate:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type_modifier': b'o'}, 4: {'type_modifier': b'o'}}})
    r(b'NSCalendar', b'rangeOfWeekendStartDate:interval:containingDate:', {'retval': {'type': b'Z'}})
    r(b'NSCalendarDate', b'years:months:days:hours:minutes:seconds:sinceDate:', {'retval': {'type': 'v'}, 'arguments': {2: {'type_modifier': b'o'}, 3: {'type_modifier': b'o'}, 4: {'type_modifier': b'o'}, 5: {'type_modifier': b'o'}, 6: {'type_modifier': b'o'}, 7: {'type_modifier': b'o'}, 8: {'type': '@'}}})
    r(b'NSCharacterSet', b'characterIsMember:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': 'S'}}})
    ...
    r(b'NSCoder', b'decodeArrayOfObjCType:count:at:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type': 'r*'}, 4: {'type_modifier': b'o', 'c_array_of_variable_length': True}}})
    r(b'NSCoder', b'decodeBoolForKey:', {'retval': {'type': 'Z'}})
    r(b'NSCoder', b'decodeBytesForKey:returnedLength:', {'retval': {'c_array_delimited_by_null': True, 'type': '^v', 'c_array_length_in_arg': 3}, 'arguments': {3: {'type_modifier': b'o'}}})
    ...
    r(b'NSCoder', b'decodePointForKey:', {'retval': {'type': sel32or64(b'{_NSPoint=ff}', b'{CGPoint=dd}')}, 'arguments': {2: {'type': '@'}}})
    r(b'NSCoder', b'decodeRect', {'retval': {'type': sel32or64(b'{_NSRect={_NSPoint=ff}{_NSSize=ff}}', b'{CGRect={CGPoint=dd}{CGSize=dd}}')}})
    r(b'NSCoder', b'decodeRectForKey:', {'retval': {'type': sel32or64(b'{_NSRect={_NSPoint=ff}{_NSSize=ff}}', b'{CGRect={CGPoint=dd}{CGSize=dd}}')}, 'arguments': {2: {'type': '@'}}})
    r(b'NSCoder', b'decodeSize', {'retval': {'type': sel32or64(b'{_NSSize=ff}', b'{CGSize=dd}')}})
    r(b'NSCoder', b'decodeSizeForKey:', {'retval': {'type': sel32or64(b'{_NSSize=ff}', b'{CGSize=dd}')}, 'arguments': {2: {'type': '@'}}})
    r(b'NSCoder', b'decodeTopLevelObjectAndReturnError:', {'arguments': {2: {'type_modifier': b'o'}}})
    r(b'NSCoder', b'decodeTopLevelObjectOfClass:forKey:error:', {'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSCoder', b'decodeValueOfObjCType:at:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type': '^t', 'type_modifier': b'n'}, 3: {'type': '^v', 'c_array_of_variable_length': True}}})
    r(b'NSCoder', b'decodeValuesOfObjCTypes:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type': '^t', 'type_modifier': b'n'}}, 'variadic': True})
    r(b'NSCoder', b'encodeArrayOfObjCType:count:at:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type': '^t', 'type_modifier': b'n'}, 4: {'type': '^v', 'type_modifier': b'n', 'c_array_of_variable_length': True}}})
    ...
    r(b'NSCoder', b'encodeBytes:length:forKey:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 3}}})
    ...
    r(b'NSCoder', b'encodeValueOfObjCType:at:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type': '^t', 'type_modifier': b'n'}, 3: {'type': '^v', 'type_modifier': b'n', 'c_array_of_variable_length': True}}})
    r(b'NSCoder', b'encodeValuesOfObjCTypes:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type': '^t', 'type_modifier': b'n'}}, 'variadic': True})
    r(b'NSCoder', b'requiresSecureCoding', {'retval': {'type': b'Z'}})
    r(b'NSComparisonPredicate', b'initWithLeftExpression:rightExpression:customSelector:', {'arguments': {4: {'sel_of_type': b'Z@:@'}}})
    r(b'NSComparisonPredicate', b'predicateWithLeftExpression:rightExpression:customSelector:', {'arguments': {4: {'sel_of_type': b'Z@:@'}}})
    ...
    r(b'NSConnection', b'setIndependentConversationQueueing:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSData', b'bytes', {'retval': {'c_array_of_variable_length': True}})
    r(b'NSData', b'dataWithBytes:length:', {'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 3}}})
    r(b'NSData', b'dataWithBytesNoCopy:length:', {'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 3}}})
    r(b'NSData', b'dataWithBytesNoCopy:length:freeWhenDone:', {'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 4: {'type': 'Z'}}})
    ...
    r(b'NSData', b'enumerateByteRangesUsingBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'^v', 'type_modifier': 'n', 'c_array_length_in_arg': 2}, 2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSData', b'getBytes:', {'arguments': {2: {'type': '^v'}}, 'suggestion': 'use -bytes instead'})
    ...
    r(b'NSData', b'initWithBytesNoCopy:length:deallocator:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'^v', 'type_modifier': 'n', 'c_array_length_in_arg': 2}, 2: {'type': sel32or64(b'I', b'Q')}}}}}})
    r(b'NSData', b'initWithBytesNoCopy:length:freeWhenDone:', {'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 4: {'type': 'Z'}}})
    ...
    r(b'NSData', b'writeToFile:atomically:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': 'Z'}}})
    r(b'NSData', b'writeToFile:options:error:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSData', b'writeToURL:atomically:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': 'Z'}}})
    r(b'NSData', b'writeToURL:options:error:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type_modifier': b'o'}}})
    ...
    r(b'NSDateComponentsFormatter', b'getObjectValue:forString:errorDescription:', {'retval': {'type': b'Z'}})
    r(b'NSDateComponentsFormatter', b'includesApproximationPhrase', {'retval': {'type': b'Z'}})
    r(b'NSDateComponentsFormatter', b'includesTimeRemainingPhrase', {'retval': {'type': b'Z'}})
    r(b'NSDateComponentsFormatter', b'setAllowsFractionalUnits:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSDateComponentsFormatter', b'setCollapsesLargestUnit:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSDateComponentsFormatter', b'setIncludesApproximationPhrase:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSDateComponentsFormatter', b'setIncludesTimeRemainingPhrase:', {'arguments': {2: {'type': b'Z'}}})
    ...
    r(b'NSDateFormatter', b'getObjectValue:forString:range:error:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type_modifier': b'o'}, 4: {'type': sel32or64(b'^{_NSRange=II}', b'^{_NSRange=QQ}'), 'type_modifier': b'N'}, 5: {'type_modifier': b'o'}}})
    r(b'NSDateFormatter', b'initWithDateFormat:allowNaturalLanguage:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSDateFormatter', b'isLenient', {'retval': {'type': 'Z'}})
    r(b'NSDateFormatter', b'setDoesRelativeDateFormatting:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSDateFormatter', b'setGeneratesCalendarDates:', {'arguments': {2: {'type': 'Z'}}})
    ...
    r(b'NSDecimalNumber', b'decimalNumberWithDecimal:', {'arguments': {2: {'type': '{NSDecimal=b8b4b1b1b18[8S]}'}}})
    r(b'NSDecimalNumber', b'decimalNumberWithMantissa:exponent:isNegative:', {'arguments': {4: {'type': 'Z'}}})
    r(b'NSDecimalNumber', b'decimalValue', {'retval': {'type': b'{_NSDecimal=b8b4b1b1b18[8S]}'}})
    r(b'NSDecimalNumber', b'initWithDecimal:', {'arguments': {2: {'type': '{NSDecimal=b8b4b1b1b18[8S]}'}}})
    r(b'NSDecimalNumber', b'initWithMantissa:exponent:isNegative:', {'arguments': {4: {'type': 'Z'}}})
    r(b'NSDecimalNumber', b'objCType', {'retval': {'c_array_delimited_by_null': True, 'type': '^t'}})
    r(b'NSDecimalNumberHandler', b'decimalNumberHandlerWithRoundingMode:scale:raiseOnExactness:raiseOnOverflow:raiseOnUnderflow:raiseOnDivideByZero:', {'arguments': {4: {'type': 'Z'}, 5: {'type': 'Z'}, 6: {'type': 'Z'}, 7: {'type': 'Z'}}})
    r(b'NSDecimalNumberHandler', b'initWithRoundingMode:scale:raiseOnExactness:raiseOnOverflow:raiseOnUnderflow:raiseOnDivideByZero:', {'arguments': {4: {'type': 'Z'}, 5: {'type': 'Z'}, 6: {'type': 'Z'}, 7: {'type': 'Z'}}})
    r(b'NSDictionary', b'dictionaryWithContentsOfURL:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    ...
    r(b'NSDictionary', b'enumerateKeysAndObjectsUsingBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSDictionary', b'enumerateKeysAndObjectsWithOptions:usingBlock:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    ...
    r(b'NSDictionary', b'getObjects:andKeys:', {'arguments': {2: {'type': '^@'}, 3: {'type': '^@'}}, 'suggestion': 'convert to a python dict instead'})
    r(b'NSDictionary', b'initWithContentsOfURL:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSDictionary', b'initWithDictionary:copyItems:', {'arguments': {3: {'type': 'Z'}}})
    ...
    r(b'NSDictionary', b'keysOfEntriesPassingTest:', {'arguments': {2: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSDictionary', b'keysOfEntriesWithOptions:passingTest:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSDictionary', b'keysSortedByValueUsingComparator:', {'arguments': {2: {'callable': {'retval': {'type': b'i'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSDictionary', b'keysSortedByValueUsingSelector:', {'arguments': {2: {'sel_of_type': b'i@:@'}}})
    r(b'NSDictionary', b'keysSortedByValueWithOptions:usingComparator:', {'arguments': {3: {'callable': {'retval': {'type': sel32or64(b'i', b'q')}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSDictionary', b'writeToFile:atomically:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': 'Z'}}})
    r(b'NSDictionary', b'writeToURL:atomically:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': 'Z'}}})
    r(b'NSDictionary', b'writeToURL:error:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type_modifier': b'o'}}})
    ...
    r(b'NSDistributedNotificationCenter', b'postNotificationName:object:userInfo:deliverImmediately:', {'arguments': {5: {'type': 'Z'}}})
    r(b'NSDistributedNotificationCenter', b'setSuspended:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSDistributedNotificationCenter', b'suspended', {'retval': {'type': 'Z'}})
    r(b'NSEnergyFormatter', b'getObjectValue:forString:errorDescription:', {'retval': {'type': b'Z'}})
    ...
    r(b'NSError', b'setUserInfoValueProviderForDomain:provider:', {'arguments': {3: {'callable': {'retval': {'type': b'@'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSError', b'userInfoValueProviderForDomain:', {'retval': {'callable': {'retval': {'type': b'@'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}})
    r(b'NSException', b'raise:format:', {'arguments': {3: {'printf_format': True, 'type': '@'}}, 'variadic': True})
    r(b'NSException', b'raise:format:arguments:', {'arguments': {4: {'type': sel32or64(b'*', b'[1{?=II^v^v}]')}}, 'suggestion': 'use raise:format:'})
    r(b'NSExpression', b'expressionBlock', {'retval': {'callable': {'retval': {'type': b'@'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}}})
    r(b'NSExpression', b'expressionForBlock:arguments:', {'arguments': {2: {'callable': {'retval': {'type': b'@'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}}}})
    r(b'NSExpression', b'expressionWithFormat:', {'arguments': {2: {'printf_format': True}}, 'variadic': True})
    r(b'NSExtensionContext', b'completeRequestReturningItems:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'Z'}}}}}})
    r(b'NSExtensionContext', b'openURL:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'Z'}}}}}})
    r(b'NSFileCoordinator', b'coordinateAccessWithIntents:queue:byAccessor:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSFileCoordinator', b'coordinateReadingItemAtURL:options:error:byAccessor:', {'arguments': {4: {'type_modifier': b'o'}, 5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSFileCoordinator', b'coordinateReadingItemAtURL:options:writingItemAtURL:options:error:byAccessor:', {'arguments': {6: {'type_modifier': b'o'}, 7: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSFileCoordinator', b'coordinateWritingItemAtURL:options:error:byAccessor:', {'arguments': {4: {'type_modifier': b'o'}, 5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSFileCoordinator', b'coordinateWritingItemAtURL:options:writingItemAtURL:options:error:byAccessor:', {'arguments': {6: {'type_modifier': b'o'}, 7: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSFileCoordinator', b'prepareForReadingItemsAtURLs:options:writingItemsAtURLs:options:error:byAccessor:', {'arguments': {6: {'type_modifier': b'o'}, 7: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'callable': {'retval': {'type': 'v'}, 'arguments': {0: {'type': '^v'}}}, 'type': b'@?'}}}}}})
    ...
    r(b'NSFileHandle', b'initWithFileDescriptor:closeOnDealloc:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSFileHandle', b'readabilityHandler', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}})
    r(b'NSFileHandle', b'setReadabilityHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSFileHandle', b'setWriteabilityHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSFileHandle', b'writeabilityHandler', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}})
    r(b'NSFileManager', b'URLForDirectory:inDomain:appropriateForURL:create:error:', {'arguments': {5: {'type': 'Z'}, 6: {'type_modifier': b'o'}}})
    ...
    r(b'NSFileManager', b'copyItemAtPath:toPath:error:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'copyItemAtURL:toURL:error:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type_modifier': b'o'}}})
    ...
    r(b'NSFileManager', b'createDirectoryAtPath:withIntermediateDirectories:attributes:error:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': 'Z'}, 5: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'createDirectoryAtURL:withIntermediateDirectories:attributes:error:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': 'Z'}, 5: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'createFileAtPath:contents:attributes:', {'retval': {'type': 'Z'}})
    r(b'NSFileManager', b'createSymbolicLinkAtPath:pathContent:', {'retval': {'type': 'Z'}})
    r(b'NSFileManager', b'createSymbolicLinkAtPath:withDestinationPath:error:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'createSymbolicLinkAtURL:withDestinationURL:error:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'destinationOfSymbolicLinkAtPath:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'enumeratorAtURL:includingPropertiesForKeys:options:errorHandler:', {'arguments': {5: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSFileManager', b'evictUbiquitousItemAtURL:error:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'fileAttributesAtPath:traverseLink:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSFileManager', b'fileExistsAtPath:', {'retval': {'type': 'Z'}})
    r(b'NSFileManager', b'fileExistsAtPath:isDirectory:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': '^Z', 'type_modifier': b'o'}}})
    r(b'NSFileManager', b'fileSystemRepresentationWithPath:', {'retval': {'c_array_delimited_by_null': True, 'type': '^t'}})
    r(b'NSFileManager', b'getFileProviderMessageInterfacesForItemAtURL:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSFileManager', b'getRelationship:ofDirectory:inDomain:toItemAtURL:error:', {'retval': {'type': b'Z'}, 'arguments': {2: {'type_modifier': b'o'}, 6: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'getRelationship:ofDirectoryAtURL:toItemAtURL:error:', {'retval': {'type': b'Z'}, 'arguments': {2: {'type_modifier': b'o'}, 5: {'type_modifier': b'o'}}})
    ...
    r(b'NSFileManager', b'linkItemAtPath:toPath:error:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'linkItemAtURL:toURL:error:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'linkPath:toPath:handler:', {'retval': {'type': 'Z'}})
    r(b'NSFileManager', b'moveItemAtPath:toPath:error:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'moveItemAtURL:toURL:error:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'movePath:toPath:handler:', {'retval': {'type': 'Z'}})
    r(b'NSFileManager', b'removeFileAtPath:handler:', {'retval': {'type': 'Z'}})
    r(b'NSFileManager', b'removeItemAtPath:error:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'removeItemAtURL:error:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'replaceItemAtURL:withItemAtURL:backupItemName:options:resultingItemURL:error:', {'retval': {'type': 'Z'}, 'arguments': {6: {'type_modifier': b'o'}, 7: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'setAttributes:ofItemAtPath:error:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'setUbiquitous:itemAtURL:destinationURL:error:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': 'Z'}, 5: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'startDownloadingUbiquitousItemAtURL:error:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'stringWithFileSystemRepresentation:length:', {'arguments': {2: {'type': '^t', 'type_modifier': b'n', 'c_array_length_in_arg': 3}}})
    r(b'NSFileManager', b'subpathsOfDirectoryAtPath:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'trashItemAtURL:resultingItemURL:error:', {'retval': {'type': b'Z'}, 'arguments': {3: {'type_modifier': b'o'}, 4: {'type_modifier': b'o'}}})
    r(b'NSFileManager', b'unmountVolumeAtURL:options:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSFileVersion', b'addVersionOfItemAtURL:withContentsOfURL:options:error:', {'arguments': {5: {'type_modifier': b'o'}}})
    r(b'NSFileVersion', b'getNonlocalVersionsOfItemAtURL:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    ...
    r(b'NSFileVersion', b'removeAndReturnError:', {'retval': {'type': b'Z'}, 'arguments': {2: {'type_modifier': b'o'}}})
    r(b'NSFileVersion', b'removeOtherVersionsOfItemAtURL:error:', {'retval': {'type': b'Z'}, 'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSFileVersion', b'replaceItemAtURL:options:error:', {'arguments': {4: {'type_modifier': b'o'}}})
    ...
    r(b'NSFileVersions', b'removeAndReturnError:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type_modifier': b'o'}}})
    r(b'NSFileVersions', b'removeOtherVersionsOfItemAtURL:error:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type_modifier': b'o'}}})
    ...
    r(b'NSFileWrapper', b'writeToURL:options:originalContentsURL:error:', {'retval': {'type': b'Z'}})
    r(b'NSFormatter', b'getObjectValue:forString:errorDescription:', {'retval': {'type': 'Z'}, 'arguments': {2: {'null_accepted': False, 'type_modifier': b'o'}, 4: {'type_modifier': b'o'}}})
    r(b'NSFormatter', b'isPartialStringValid:newEditingString:errorDescription:', {'retval': {'type': 'Z'}, 'arguments': {3: {'null_accepted': False, 'type_modifier': b'N'}, 4: {'type_modifier': b'o'}}})
    r(b'NSFormatter', b'isPartialStringValid:proposedSelectedRange:originalString:originalSelectedRange:errorDescription:', {'retval': {'type': 'Z'}, 'arguments': {2: {'null_accepted': False, 'type_modifier': b'N'}, 3: {'null_accepted': False, 'type_modifier': b'N'}, 5: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 6: {'type_modifier': b'o'}}})
    r(b'NSGarbageCollector', b'disableCollectorForPointer:', {'arguments': {2: {'type': '^v'}}, 'suggestion': 'Not supported right now'})
    r(b'NSGarbageCollector', b'enableCollectorForPointer:', {'arguments': {2: {'type': '^v'}}, 'suggestion': 'Not supported right now'})
    ...
    r(b'NSHTTPCookieStorage', b'getCookiesForTask:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    ...
    r(b'NSIndexPath', b'getIndexes:', {'arguments': {2: {'type': sel32or64(b'^I', b'^Q'), 'type_modifier': b'o', 'c_array_of_variable_length': True}}, 'suggestion': 'Use -getIndexes:range: or -indexAtPosition: instead'})
    r(b'NSIndexPath', b'getIndexes:range:', {'arguments': {2: {'type': sel32or64(b'^I', b'^Q'), 'type_modifier': b'o', 'c_array_length_in_arg': 3}}})
    ...
    r(b'NSIndexSet', b'containsIndexesInRange:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSIndexSet', b'countOfIndexesInRange:', {'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSIndexSet', b'enumerateIndexesInRange:options:usingBlock:', {'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'I', b'Q')}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSIndexSet', b'enumerateIndexesUsingBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'I', b'Q')}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSIndexSet', b'enumerateIndexesWithOptions:usingBlock:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'I', b'Q')}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSIndexSet', b'enumerateRangesInRange:options:usingBlock:', {'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSIndexSet', b'enumerateRangesUsingBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSIndexSet', b'enumerateRangesWithOptions:usingBlock:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSIndexSet', b'getIndexes:maxCount:inIndexRange:', {'arguments': {2: {'null_accepted': False, 'c_array_length_in_arg': 3, 'c_array_length_in_result': True, 'type_modifier': b'o'}, 4: {'null_accepted': False, 'type_modifier': b'N'}}})
    r(b'NSIndexSet', b'indexInRange:options:passingTest:', {'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 4: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'I', b'Q')}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSIndexSet', b'indexPassingTest:', {'arguments': {2: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'I', b'Q')}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSIndexSet', b'indexSetWithIndexesInRange:', {'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSIndexSet', b'indexWithOptions:passingTest:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'I', b'Q')}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSIndexSet', b'indexesInRange:options:passingTest:', {'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 4: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'I', b'Q')}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSIndexSet', b'indexesPassingTest:', {'arguments': {2: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'I', b'Q')}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSIndexSet', b'indexesWithOptions:passingTest:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'I', b'Q')}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSIndexSet', b'initWithIndexesInRange:', {'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSIndexSet', b'intersectsIndexesInRange:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSIndexSet', b'isEqualToIndexSet:', {'retval': {'type': 'Z'}})
    r(b'NSInputStream', b'getBuffer:length:', {'retval': {'type': b'Z'}, 'arguments': {2: {'type': '^*', 'type_modifier': b'o', 'c_array_length_in_arg': 3}, 3: {'type': sel32or64(b'^I', b'^Q'), 'type_modifier': b'o'}}, 'suggestion': 'Not supported at the moment'})
    r(b'NSInputStream', b'hasBytesAvailable', {'retval': {'type': 'Z'}})
    r(b'NSInputStream', b'read:maxLength:', {'arguments': {2: {'type': '^v', 'c_array_length_in_arg': 3, 'c_array_length_in_result': True, 'type_modifier': b'o'}}})
    ...
    r(b'NSItemProvider', b'hasItemConformingToTypeIdentifier:', {'retval': {'type': b'Z'}})
    r(b'NSItemProvider', b'hasRepresentationConformingToTypeIdentifier:fileOptions:', {'retval': {'type': 'Z'}})
    r(b'NSItemProvider', b'loadDataRepresentationForTypeIdentifier:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSItemProvider', b'loadFileRepresentationForTypeIdentifier:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSItemProvider', b'loadInPlaceFileRepresentationForTypeIdentifier:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'Z'}, 3: {'type': b'@'}}}}}})
    r(b'NSItemProvider', b'loadPreviewImageWithOptions:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSItemProvider', b'previewImageHandler', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'callable': {'retval': {'type': 'v'}, 'arguments': {0: {'type': '^v'}, 1: {'type': '@'}, 2: {'type': '@'}}}, 'type': b'@?'}, 2: {'type': b'#'}, 3: {'type': b'@'}}}, 'type': '@?'}})
    r(b'NSItemProvider', b'registerDataRepresentationForTypeIdentifier:visibility:loadHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'@'}, 'arguments': {0: {'type': b'^v'}, 1: {'callable': {'retval': {'type': 'v'}, 'arguments': {0: {'type': '^v'}, 1: {'type': '@'}, 2: {'type': '@'}}}, 'type': b'@?'}}}}}})
    r(b'NSItemProvider', b'registerFileRepresentationForTypeIdentifier:fileOptions:visibility:loadHandler:', {'arguments': {5: {'callable': {'retval': {'type': b'@'}, 'arguments': {0: {'type': b'^v'}, 1: {'callable': {'retval': {'type': 'v'}, 'arguments': {0: {'type': '^v'}, 1: {'type': '@'}, 2: {'type': 'Z'}, 3: {'type': '@'}}}, 'type': b'@?'}}}}}})
    r(b'NSItemProvider', b'registerObjectOfClass:visibility:loadHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'@'}, 'arguments': {0: {'type': b'^v'}, 1: {'callable': {'retval': {'type': 'v'}, 'arguments': {0: {'type': '^v'}, 1: {'type': '@'}, 2: {'type': '@'}}}, 'type': b'@?'}}}}}})
    r(b'NSItemProvider', b'setPreviewImageHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'callable': {'retval': {'type': 'v'}, 'arguments': {0: {'type': '^v'}, 1: {'type': '@'}, 2: {'type': '@'}}}, 'type': b'@?'}, 2: {'type': b'#'}, 3: {'type': b'@'}}}, 'type': '@?'}}})
    ...
    r(b'NSJSONSerialization', b'isValidJSONObject:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSKeyedArchiver', b'archivedDataWithRootObject:requiringSecureCoding:error:', {'arguments': {3: {'type': 'Z'}, 4: {'type_modifier': b'o'}}})
    r(b'NSKeyedArchiver', b'encodeBool:forKey:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSKeyedArchiver', b'encodeBytes:length:forKey:', {'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 3}}})
    r(b'NSKeyedArchiver', b'initRequiringSecureCoding:', {'arguments': {2: {'type': 'Z'}}})
    ...
    r(b'NSKeyedUnarchiver', b'decodeBytesForKey:returnedLength:', {'retval': {'type': '^v', 'c_array_length_in_arg': 3}, 'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSKeyedUnarchiver', b'initForReadingFromData:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSKeyedUnarchiver', b'setRequiresSecureCoding:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSKeyedUnarchiver', b'unarchivedObjectOfClass:fromData:error:', {'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSKeyedUnarchiver', b'unarchivedObjectOfClasses:fromData:error:', {'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSLengthFormatter', b'getObjectValue:forString:errorDescription:', {'retval': {'type': b'Z'}})
    ...
    r(b'NSLinguisticTagger', b'enumerateTagsForString:range:unit:scheme:options:orthography:usingBlock:', {'arguments': {8: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 3: {'type': b'o^Z'}}}}}})
    r(b'NSLinguisticTagger', b'enumerateTagsInRange:scheme:options:usingBlock:', {'arguments': {5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 3: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 4: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSLinguisticTagger', b'enumerateTagsInRange:unit:scheme:options:usingBlock:', {'arguments': {6: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 3: {'type': b'o^Z'}}}}}})
    ...
    r(b'NSLinguisticTagger', b'tagAtIndex:unit:scheme:tokenRange:', {'arguments': {5: {'type_modifier': b'o'}}})
    r(b'NSLinguisticTagger', b'tagForString:atIndex:unit:scheme:orthography:tokenRange:', {'arguments': {7: {'type_modifier': b'o'}}})
    r(b'NSLinguisticTagger', b'tagsForString:range:unit:scheme:options:orthography:tokenRanges:', {'arguments': {8: {'type_modifier': b'o'}}})
    r(b'NSLinguisticTagger', b'tagsInRange:scheme:options:tokenRanges:', {'arguments': {5: {'type_modifier': b'o'}}})
    r(b'NSLinguisticTagger', b'tagsInRange:unit:scheme:options:tokenRanges:', {'arguments': {6: {'type_modifier': b'o'}}})
    ...
    r(b'NSMassFormatter', b'getObjectValue:forString:errorDescription:', {'retval': {'type': b'Z'}})
    ...
    r(b'NSMetadataQuery', b'enumerateResultsUsingBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'o^Z'}}}}}})
    r(b'NSMetadataQuery', b'enumerateResultsWithOptions:usingBlock:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'o^Z'}}}}}})
    ...
    r(b'NSMethodSignature', b'getArgumentTypeAtIndex:', {'retval': {'c_array_delimited_by_null': True, 'type': '^t'}})
    r(b'NSMethodSignature', b'isOneway', {'retval': {'type': 'Z'}})
    r(b'NSMethodSignature', b'methodReturnType', {'retval': {'c_array_delimited_by_null': True, 'type': '^t'}})
    r(b'NSMethodSignature', b'signatureWithObjCTypes:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type': '^t', 'type_modifier': b'n'}}})
    ...
    r(b'NSMutableArray', b'sortUsingComparator:', {'arguments': {2: {'callable': {'retval': {'type': sel32or64(b'i', b'q')}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSMutableArray', b'sortUsingFunction:context:', {'arguments': {2: {'callable': {'retval': {'type': b'l'}, 'arguments': {0: {'type': b'@'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}, 'callable_retained': False}, 3: {'type': '@'}}})
    r(b'NSMutableArray', b'sortUsingFunction:context:range:', {'arguments': {2: {'callable': {'retval': {'type': b'l'}, 'arguments': {0: {'type': b'@'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}, 'callable_retained': False}, 3: {'type': '@'}, 4: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSMutableArray', b'sortUsingSelector:', {'arguments': {2: {'sel_of_type': b'i@:@'}}})
    r(b'NSMutableArray', b'sortWithOptions:usingComparator:', {'arguments': {3: {'callable': {'retval': {'type': sel32or64(b'i', b'q')}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    ...
    r(b'NSMutableData', b'mutableBytes', {'retval': {'type': '^v'}, 'suggestion': 'use your language native array access on this object'})
    ...
    r(b'NSMutableOrderedSet', b'sortRange:options:usingComparator:', {'arguments': {4: {'callable': {'retval': {'type': sel32or64(b'i', b'q')}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSMutableOrderedSet', b'sortUsingComparator:', {'arguments': {2: {'callable': {'retval': {'type': sel32or64(b'i', b'q')}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSMutableOrderedSet', b'sortWithOptions:usingComparator:', {'arguments': {3: {'callable': {'retval': {'type': sel32or64(b'i', b'q')}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSMutableString', b'appendFormat:', {'arguments': {2: {'printf_format': True, 'type': '@'}}, 'variadic': True})
    r(b'NSMutableString', b'applyTransform:reverse:range:updatedRange:', {'arguments': {3: {'type': 'Z'}, 5: {'type_modifier': b'o'}}})
    ...
    r(b'NSMutableURLRequest', b'setAllowsCellularAccess:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSMutableURLRequest', b'setHTTPShouldHandleCookies:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSMutableURLRequest', b'setHTTPShouldUsePipelining:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSNetService', b'getInputStream:outputStream:', {'retval': {'type': 'Z'}, 'arguments': {2: {'null_accepted': False, 'type_modifier': b'o'}, 3: {'null_accepted': False, 'type_modifier': b'o'}}})
    r(b'NSNetService', b'includesPeerToPeer', {'retval': {'type': 'Z'}})
    r(b'NSNetService', b'setIncludesPeerToPeer:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'Z'}}})
    r(b'NSNetService', b'setTXTRecordData:', {'retval': {'type': 'Z'}})
    r(b'NSNetServiceBrowser', b'includesPeerToPeer', {'retval': {'type': 'Z'}})
    r(b'NSNetServiceBrowser', b'setIncludesPeerToPeer:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'Z'}}})
    r(b'NSNotificationCenter', b'addObserver:selector:name:object:', {'arguments': {3: {'sel_of_type': b'v@:@'}}})
    r(b'NSNotificationCenter', b'addObserverForName:object:queue:usingBlock:', {'arguments': {5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSNotificationCenter', b'addObserverForName:object:usingBlock:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    ...
    r(b'NSNumberFormatter', b'getObjectValue:forString:range:error:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type_modifier': b'o'}, 4: {'type_modifier': b'N'}, 5: {'type_modifier': b'o'}}})
    r(b'NSNumberFormatter', b'hasThousandSeparators', {'retval': {'type': 'Z'}})
    r(b'NSNumberFormatter', b'isLenient', {'retval': {'type': 'Z'}})
    r(b'NSNumberFormatter', b'isPartialStringValidationEnabled', {'retval': {'type': 'Z'}})
    r(b'NSNumberFormatter', b'localizesFormat', {'retval': {'type': 'Z'}})
    r(b'NSNumberFormatter', b'setAllowsFloats:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSNumberFormatter', b'setAlwaysShowsDecimalSeparator:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSNumberFormatter', b'setGeneratesDecimalNumbers:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSNumberFormatter', b'setHasThousandSeparators:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSNumberFormatter', b'setLenient:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSNumberFormatter', b'setLocalizesFormat:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSNumberFormatter', b'setPartialStringValidationEnabled:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSNumberFormatter', b'setUsesGroupingSeparator:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': 'Z'}}})
    r(b'NSNumberFormatter', b'setUsesSignificantDigits:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': 'Z'}}})
    r(b'NSNumberFormatter', b'usesGroupingSeparator', {'retval': {'type': 'Z'}})
    r(b'NSNumberFormatter', b'usesSignificantDigits', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'URL:resourceDataDidBecomeAvailable:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'URL:resourceDidFailLoadingWithReason:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'URLHandle:resourceDataDidBecomeAvailable:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'URLHandle:resourceDidFailLoadingWithReason:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'URLHandleResourceDidBeginLoading:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'URLHandleResourceDidCancelLoading:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'URLHandleResourceDidFinishLoading:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'URLProtocol:cachedResponseIsValid:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'URLProtocol:didCancelAuthenticationChallenge:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'URLProtocol:didFailWithError:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'URLProtocol:didLoadData:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'URLProtocol:didReceiveAuthenticationChallenge:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'URLProtocol:didReceiveResponse:cacheStoragePolicy:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': sel32or64(b'I', b'Q')}}})
    r(b'NSObject', b'URLProtocol:wasRedirectedToRequest:redirectResponse:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'URLProtocolDidFinishLoading:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'URLResourceDidCancelLoading:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'URLResourceDidFinishLoading:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'URLSession:dataTask:didBecomeDownloadTask:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'URLSession:dataTask:didReceiveData:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'URLSession:dataTask:didReceiveResponse:completionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'I', b'Q')}}}, 'type': b'@?'}}})
    r(b'NSObject', b'URLSession:dataTask:willCacheResponse:completionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}, 'type': b'@?'}}})
    r(b'NSObject', b'URLSession:didBecomeInvalidWithError:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'URLSession:didReceiveChallenge:completionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'I', b'Q')}, 2: {'type': b'@'}}}, 'type': b'@?'}}})
    r(b'NSObject', b'URLSession:downloadTask:didFinishDownloadingToURL:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'URLSession:downloadTask:didResumeAtOffset:expectedTotalBytes:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'q'}, 5: {'type': b'q'}}})
    r(b'NSObject', b'URLSession:downloadTask:didWriteData:totalBytesWritten:totalBytesExpectedToWrite:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'q'}, 5: {'type': b'q'}, 6: {'type': b'q'}}})
    r(b'NSObject', b'URLSession:task:didCompleteWithError:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'URLSession:task:didReceiveChallenge:completionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'I', b'Q')}, 2: {'type': b'@'}}}, 'type': b'@?'}}})
    r(b'NSObject', b'URLSession:task:didSendBodyData:totalBytesSent:totalBytesExpectedToSend:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'q'}, 5: {'type': b'q'}, 6: {'type': b'q'}}})
    r(b'NSObject', b'URLSession:task:needNewBodyStream:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}, 'type': b'@?'}}})
    r(b'NSObject', b'URLSession:task:willBeginDelayedRequest:completionHandler:', {'arguments': {5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': sel32or64(b'i', b'q')}, 2: {'type': b'@'}}}, 'type': '@?'}}})
    r(b'NSObject', b'URLSession:task:willPerformHTTPRedirection:newRequest:completionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}, 6: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}, 'type': b'@?'}}})
    r(b'NSObject', b'URLSessionDidFinishEventsForBackgroundURLSession:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'accessInstanceVariablesDirectly', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'accommodatePresentedItemDeletionWithCompletionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}, 'type': '@?'}}})
    r(b'NSObject', b'accommodatePresentedSubitemDeletionAtURL:completionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}, 'type': '@?'}}})
    r(b'NSObject', b'addObserver:forKeyPath:options:context:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': 'I'}, 5: {'type': '^v'}}})
    r(b'NSObject', b'allowsWeakReference', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'archiver:didEncodeObject:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'archiver:willEncodeObject:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'archiver:willReplaceObject:withObject:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'archiverDidFinish:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'archiverWillFinish:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'attemptRecoveryFromError:optionIndex:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': sel32or64(b'I', b'Q')}}})
    r(b'NSObject', b'attemptRecoveryFromError:optionIndex:delegate:didRecoverSelector:contextInfo:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': sel32or64(b'I', b'Q')}, 4: {'type': b'@'}, 5: {'type': b':', 'sel_of_type': b'v@:Z^v'}, 6: {'type': '^v'}}})
    r(b'NSObject', b'attributeKeys', {'retval': {'type': b'@'}})
    r(b'NSObject', b'authenticateComponents:withData:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'authenticationDataForComponents:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'autoContentAccessingProxy', {'retval': {'type': b'@'}})
    r(b'NSObject', b'automaticallyNotifiesObserversForKey:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'autorelease', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'awakeAfterUsingCoder:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'beginContentAccess', {'required': True, 'retval': {'type': 'Z'}})
    r(b'NSObject', b'beginRequestWithExtensionContext:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'cache:willEvictObject:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'cancelAuthenticationChallenge:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'cancelPreviousPerformRequestsWithTarget:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'cancelPreviousPerformRequestsWithTarget:selector:object:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': ':', 'sel_of_type': b'v@:@'}, 4: {'type': b'@'}}})
    ...
    r(b'NSObject', b'coerceValue:forKey:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'commitEditingAndReturnError:', {'arguments': {2: {'type': 'o'}}})
    r(b'NSObject', b'conformsToProtocol:', {'required': True, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'connection:canAuthenticateAgainstProtectionSpace:', {'required': False, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'connection:didCancelAuthenticationChallenge:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'connection:didFailWithError:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'connection:didReceiveAuthenticationChallenge:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'connection:didReceiveData:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'connection:didReceiveResponse:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'connection:didSendBodyData:totalBytesWritten:totalBytesExpectedToWrite:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': sel32or64(b'i', b'q')}, 4: {'type': sel32or64(b'i', b'q')}, 5: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'connection:didWriteData:totalBytesWritten:expectedTotalBytes:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'q'}, 4: {'type': b'q'}, 5: {'type': b'q'}}})
    r(b'NSObject', b'connection:handleRequest:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'connection:needNewBodyStream:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'connection:shouldMakeNewConnection:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'connection:willCacheResponse:', {'required': False, 'retval': {'type': '@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'connection:willSendRequest:redirectResponse:', {'required': False, 'retval': {'type': '@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'connection:willSendRequestForAuthenticationChallenge:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'connectionDidFinishDownloading:destinationURL:', {'required': True, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'connectionDidFinishLoading:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'copyScriptingValue:forKey:withProperties:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    ...
    r(b'NSObject', b'dictionaryWithValuesForKeys:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'didChange:valuesAtIndexes:forKey:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': 'I'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'didChangeValueForKey:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'didChangeValueForKey:withSetMutation:usingObjects:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'I'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'discardContentIfPossible', {'required': True, 'retval': {'type': b'v'}})
    r(b'NSObject', b'doesContain:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'doesNotRecognizeSelector:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': ':'}}})
    r(b'NSObject', b'download:canAuthenticateAgainstProtectionSpace:', {'required': False, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'download:decideDestinationWithSuggestedFilename:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'download:didCancelAuthenticationChallenge:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'download:didCreateDestination:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'download:didFailWithError:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'download:didReceiveAuthenticationChallenge:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'download:didReceiveDataOfLength:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': sel32or64(b'I', b'Q')}}})
    r(b'NSObject', b'download:didReceiveResponse:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'download:shouldDecodeSourceDataOfMIMEType:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'download:willResumeWithResponse:fromByte:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': 'q'}}})
    r(b'NSObject', b'download:willSendRequest:redirectResponse:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'downloadDidBegin:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'downloadDidFinish:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'downloadShouldUseCredentialStorage:', {'required': False, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'encodeWithCoder:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'endContentAccess', {'required': True, 'retval': {'type': b'v'}})
    r(b'NSObject', b'exceptionDuringOperation:error:leftOperand:rightOperand:', {'required': True, 'retval': {'type': '@'}, 'arguments': {2: {'type': ':'}, 3: {'type': sel32or64(b'I', b'Q')}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldCopyItemAtPath:toPath:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldCopyItemAtURL:toURL:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldLinkItemAtPath:toPath:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldLinkItemAtURL:toURL:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldMoveItemAtPath:toPath:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldMoveItemAtURL:toURL:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldProceedAfterError:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldProceedAfterError:copyingItemAtPath:toPath:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldProceedAfterError:copyingItemAtURL:toURL:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldProceedAfterError:linkingItemAtPath:toPath:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldProceedAfterError:linkingItemAtURL:toURL:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldProceedAfterError:movingItemAtPath:toPath:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldProceedAfterError:movingItemAtURL:toURL:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldProceedAfterError:removingItemAtPath:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldProceedAfterError:removingItemAtURL:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldRemoveItemAtPath:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:shouldRemoveItemAtURL:', {'required': False, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'fileManager:willProcessPath:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'forwardInvocation:', {'retval': {'type': 'v'}})
    r(b'NSObject', b'handleMachMessage:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': '^v'}}})
    r(b'NSObject', b'handlePortMessage:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'handleQueryWithUnboundKey:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'handleTakeValue:forUnboundKey:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'hash', {'required': True, 'retval': {'type': sel32or64(b'I', b'Q')}})
    r(b'NSObject', b'indicesOfObjectsByEvaluatingObjectSpecifier:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'initWithCoder:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'initWithItemProviderData:typeIdentifier:error:', {'arguments': {4: {'type': '^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'initialize', {'retval': {'type': 'v'}})
    r(b'NSObject', b'insertValue:atIndex:inPropertyWithKey:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': sel32or64(b'I', b'Q')}, 4: {'type': b'@'}}})
    r(b'NSObject', b'insertValue:inPropertyWithKey:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'instanceMethodForSelector:', {'retval': {'type': '^?'}, 'arguments': {2: {'type': ':'}}})
    r(b'NSObject', b'instanceMethodSignatureForSelector:', {'arguments': {2: {'type': ':'}}})
    r(b'NSObject', b'instancesRespondToSelector:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': ':'}}})
    r(b'NSObject', b'inverseForRelationshipKey:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'isCaseInsensitiveLike:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'isEqualTo:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'isGreaterThan:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'isGreaterThanOrEqualTo:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'isKindOfClass:', {'required': True, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': '#'}}})
    r(b'NSObject', b'isLessThan:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'isLessThanOrEqualTo:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'isLike:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'isMemberOfClass:', {'required': True, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': '#'}}})
    r(b'NSObject', b'isNotEqualTo:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'isProxy', {'required': True, 'retval': {'type': 'Z'}})
    r(b'NSObject', b'isSubclassOfClass:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': '#'}}})
    r(b'NSObject', b'itemProviderVisibilityForRepresentationWithTypeIdentifier:', {'retval': {'type': sel32or64(b'i', b'q')}})
    r(b'NSObject', b'keyPathsForValuesAffectingValueForKey:', {'retval': {'type': '@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'listener:shouldAcceptNewConnection:', {'required': False, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'load', {'retval': {'type': 'v'}})
    r(b'NSObject', b'loadDataWithTypeIdentifier:forItemProviderCompletionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}, 'type': '@?'}}})
    ...
    r(b'NSObject', b'mutableArrayValueForKey:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'mutableArrayValueForKeyPath:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    ...
    r(b'NSObject', b'mutableOrderedSetValueForKey:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'mutableOrderedSetValueForKeyPath:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'mutableSetValueForKey:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'mutableSetValueForKeyPath:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'netService:didAcceptConnectionWithInputStream:outputStream:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    ...
    r(b'NSObject', b'netServiceBrowser:didFindDomain:moreComing:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': 'Z'}}})
    r(b'NSObject', b'netServiceBrowser:didFindService:moreComing:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': 'Z'}}})
    r(b'NSObject', b'netServiceBrowser:didNotSearch:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'netServiceBrowser:didRemoveDomain:moreComing:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': 'Z'}}})
    r(b'NSObject', b'netServiceBrowser:didRemoveService:moreComing:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': 'Z'}}})
    r(b'NSObject', b'netServiceBrowserDidStopSearch:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'netServiceBrowserWillSearch:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'netServiceDidPublish:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'netServiceDidResolveAddress:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'netServiceDidStop:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'netServiceWillPublish:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'netServiceWillResolve:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'newScriptingObjectOfClass:forValueForKey:withContentsValue:properties:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': '#'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'objectSpecifier', {'retval': {'type': b'@'}})
    r(b'NSObject', b'objectWithItemProviderData:typeIdentifier:error:', {'arguments': {4: {'type': '^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'observationInfo', {'retval': {'type': '^v'}})
    r(b'NSObject', b'observeValueForKeyPath:ofObject:change:context:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': '^v'}}})
    r(b'NSObject', b'parser:didEndElement:namespaceURI:qualifiedName:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'parser:didEndMappingPrefix:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'parser:didStartElement:namespaceURI:qualifiedName:attributes:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}, 6: {'type': b'@'}}})
    r(b'NSObject', b'parser:didStartMappingPrefix:toURI:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'parser:foundAttributeDeclarationWithName:forElement:type:defaultValue:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}, 6: {'type': b'@'}}})
    r(b'NSObject', b'parser:foundCDATA:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'parser:foundCharacters:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'parser:foundComment:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'parser:foundElementDeclarationWithName:model:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'parser:foundExternalEntityDeclarationWithName:publicID:systemID:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'parser:foundIgnorableWhitespace:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'parser:foundInternalEntityDeclarationWithName:value:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'parser:foundNotationDeclarationWithName:publicID:systemID:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'parser:foundProcessingInstructionWithTarget:data:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'parser:foundUnparsedEntityDeclarationWithName:publicID:systemID:notationName:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': b'@'}, 6: {'type': b'@'}}})
    r(b'NSObject', b'parser:parseErrorOccurred:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'parser:resolveExternalEntityName:systemID:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'parser:validationErrorOccurred:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'parserDidEndDocument:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'parserDidStartDocument:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'performDefaultHandlingForAuthenticationChallenge:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'performSelector:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': ':'}}})
    r(b'NSObject', b'performSelector:onThread:withObject:waitUntilDone:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b':', 'sel_of_type': b'v@:@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': 'Z'}}})
    r(b'NSObject', b'performSelector:onThread:withObject:waitUntilDone:modes:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b':', 'sel_of_type': b'v@:@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': 'Z'}, 6: {'type': b'@'}}})
    r(b'NSObject', b'performSelector:withObject:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': ':'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'performSelector:withObject:afterDelay:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b':', 'sel_of_type': b'v@:@'}, 3: {'type': b'@'}, 4: {'type': 'd'}}})
    r(b'NSObject', b'performSelector:withObject:afterDelay:inModes:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b':', 'sel_of_type': b'v@:@'}, 3: {'type': b'@'}, 4: {'type': 'd'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'performSelector:withObject:withObject:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'type': ':'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'performSelectorInBackground:withObject:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b':', 'sel_of_type': b'v@:@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'performSelectorOnMainThread:withObject:waitUntilDone:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b':', 'sel_of_type': b'v@:@'}, 3: {'type': b'@'}, 4: {'type': 'Z'}}})
    r(b'NSObject', b'performSelectorOnMainThread:withObject:waitUntilDone:modes:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b':', 'sel_of_type': b'v@:@'}, 3: {'type': b'@'}, 4: {'type': 'Z'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'poseAsClass:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': '#'}}})
    r(b'NSObject', b'presentedItemDidChange', {'required': False, 'retval': {'type': b'v'}})
    r(b'NSObject', b'presentedItemDidGainVersion:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'presentedItemDidLoseVersion:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'presentedItemDidMoveToURL:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'presentedItemDidResolveConflictVersion:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'presentedItemOperationQueue', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'presentedItemURL', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'presentedSubitemAtURL:didGainVersion:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'presentedSubitemAtURL:didLoseVersion:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'presentedSubitemAtURL:didMoveToURL:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'presentedSubitemAtURL:didResolveConflictVersion:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'presentedSubitemDidAppearAtURL:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'presentedSubitemDidChangeAtURL:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'primaryPresentedItemURL', {'required': False, 'retval': {'type': b'@'}})
    r(b'NSObject', b'rejectProtectionSpaceAndContinueWithChallenge:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'release', {'required': True, 'retval': {'type': 'Vv'}})
    r(b'NSObject', b'relinquishPresentedItemToReader:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'callable': {'retval': {'type': 'v'}, 'arguments': {0: {'type': '^v'}}}, 'type': b'@?'}}}, 'type': '@?'}}})
    r(b'NSObject', b'relinquishPresentedItemToWriter:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'callable': {'retval': {'type': 'v'}, 'arguments': {0: {'type': '^v'}}}, 'type': b'@?'}}}, 'type': '@?'}}})
    r(b'NSObject', b'remoteObjectProxy', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'remoteObjectProxyWithErrorHandler:', {'required': True, 'retval': {'type': b'@'}, 'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}, 'type': b'@?'}}})
    r(b'NSObject', b'removeObserver:forKeyPath:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'removeObserver:forKeyPath:context:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'^v'}}})
    r(b'NSObject', b'removeValueAtIndex:fromPropertyWithKey:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'@'}}})
    r(b'NSObject', b'replaceValueAtIndex:inPropertyWithKey:withValue:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'replacementObjectForArchiver:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'replacementObjectForCoder:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'replacementObjectForKeyedArchiver:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'replacementObjectForPortCoder:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'resolveClassMethod:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': ':'}}})
    r(b'NSObject', b'resolveInstanceMethod:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': ':'}}})
    r(b'NSObject', b'respondsToSelector:', {'required': True, 'retval': {'type': 'Z'}, 'arguments': {2: {'type': ':'}}})
    r(b'NSObject', b'retain', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'retainCount', {'required': True, 'retval': {'type': sel32or64(b'I', b'Q')}})
    r(b'NSObject', b'retainWeakReference', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'roundingMode', {'required': True, 'retval': {'type': sel32or64(b'I', b'Q')}})
    r(b'NSObject', b'savePresentedItemChangesWithCompletionHandler:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}, 'type': '@?'}}})
    r(b'NSObject', b'scale', {'required': True, 'retval': {'type': 's'}})
    r(b'NSObject', b'scriptingBeginsWith:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'scriptingContains:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'scriptingEndsWith:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'scriptingIsEqualTo:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'scriptingIsGreaterThan:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'scriptingIsGreaterThanOrEqualTo:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'scriptingIsLessThan:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'scriptingIsLessThanOrEqualTo:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'scriptingProperties', {'retval': {'type': b'@'}})
    r(b'NSObject', b'scriptingValueForSpecifier:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'self', {'required': True, 'retval': {'type': b'@'}})
    r(b'NSObject', b'setKeys:triggerChangeNotificationsForDependentKey:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'setNilValueForKey:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'setObservationInfo:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': '^v'}}})
    r(b'NSObject', b'setPresentedItemOperationQueue:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'setPresentedItemURL:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'setPrimaryPresentedItemURL:', {'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'setScriptingProperties:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'setValue:forKey:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'setValue:forKeyPath:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'setValue:forUndefinedKey:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'setValuesForKeysWithDictionary:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'setVersion:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': sel32or64(b'i', b'q')}}})
    r(b'NSObject', b'spellServer:checkGrammarInString:language:details:', {'required': False, 'retval': {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': '^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'spellServer:checkString:offset:types:options:orthography:wordCount:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': sel32or64(b'I', b'Q')}, 5: {'type': sel32or64(b'i', b'q')}, 6: {'type': b'@'}, 7: {'type': b'@'}, 8: {'type': sel32or64(b'^i', b'^q'), 'type_modifier': b'o'}}})
    r(b'NSObject', b'spellServer:didForgetWord:inLanguage:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'spellServer:didLearnWord:inLanguage:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'spellServer:findMisspelledWordInString:language:wordCount:countOnly:', {'required': False, 'retval': {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}, 5: {'type': sel32or64(b'^i', b'^q'), 'type_modifier': b'o'}, 6: {'type': 'Z'}}})
    r(b'NSObject', b'spellServer:recordResponse:toCorrection:forWord:language:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': sel32or64(b'I', b'Q')}, 4: {'type': b'@'}, 5: {'type': b'@'}, 6: {'type': b'@'}}})
    r(b'NSObject', b'spellServer:suggestCompletionsForPartialWordRange:inString:language:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 4: {'type': b'@'}, 5: {'type': b'@'}}})
    r(b'NSObject', b'spellServer:suggestGuessesForWord:inLanguage:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'storedValueForKey:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'stream:handleEvent:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': sel32or64(b'I', b'Q')}}})
    r(b'NSObject', b'superclass', {'required': True, 'retval': {'type': '#'}})
    r(b'NSObject', b'supportsSecureCoding', {'required': True, 'retval': {'type': 'Z'}})
    r(b'NSObject', b'takeStoredValue:forKey:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'takeValue:forKey:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'takeValue:forKeyPath:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'takeValuesFromDictionary:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'toManyRelationshipKeys', {'retval': {'type': b'@'}})
    r(b'NSObject', b'toOneRelationshipKeys', {'retval': {'type': b'@'}})
    r(b'NSObject', b'unableToSetNilForKey:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'unarchiver:cannotDecodeObjectOfClassName:originalClasses:', {'required': False, 'retval': {'type': '#'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'unarchiver:didDecodeObject:', {'required': False, 'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'unarchiver:willReplaceObject:withObject:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'unarchiverDidFinish:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'unarchiverWillFinish:', {'required': False, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'unlock', {'required': True, 'retval': {'type': 'v'}})
    r(b'NSObject', b'useCredential:forAuthenticationChallenge:', {'required': True, 'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'useStoredAccessor', {'retval': {'type': 'Z'}})
    r(b'NSObject', b'userActivity:didReceiveInputStream:outputStream:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'userActivityWasContinued:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'userActivityWillSave:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'userNotificationCenter:didActivateNotification:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'userNotificationCenter:didDeliverNotification:', {'required': False, 'retval': {'type': b'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'userNotificationCenter:shouldPresentNotification:', {'required': False, 'retval': {'type': b'Z'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'validateValue:forKey:error:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': '^@', 'type_modifier': b'N'}, 3: {'type': b'@'}, 4: {'type': '^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'validateValue:forKeyPath:error:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': '^@', 'type_modifier': b'N'}, 3: {'type': '@'}, 4: {'type': '^@', 'type_modifier': b'o'}}})
    r(b'NSObject', b'valueAtIndex:inPropertyWithKey:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'@'}}})
    r(b'NSObject', b'valueForKey:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'valueForKeyPath:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'valueForUndefinedKey:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'valueWithName:inPropertyWithKey:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'valueWithUniqueID:inPropertyWithKey:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}, 3: {'type': b'@'}}})
    r(b'NSObject', b'valuesForKeys:', {'retval': {'type': b'@'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'version', {'retval': {'type': sel32or64(b'i', b'q')}})
    r(b'NSObject', b'willChange:valuesAtIndexes:forKey:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': 'I'}, 3: {'type': b'@'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'willChangeValueForKey:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}}})
    r(b'NSObject', b'willChangeValueForKey:withSetMutation:usingObjects:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': b'@'}, 3: {'type': 'I'}, 4: {'type': b'@'}}})
    r(b'NSObject', b'zone', {'required': True, 'retval': {'type': b'^{_NSZone=}'}})
    r(b'NSOperation', b'completionBlock', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}})
    ...
    r(b'NSOperation', b'setCompletionBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'NSOperationQueue', b'addOperationWithBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'NSOperationQueue', b'addOperations:waitUntilFinished:', {'arguments': {3: {'type': 'Z'}}})
    ...
    r(b'NSOrderedSet', b'enumerateObjectsAtIndexes:options:usingBlock:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSOrderedSet', b'enumerateObjectsUsingBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSOrderedSet', b'enumerateObjectsWithOptions:usingBlock:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSOrderedSet', b'indexOfObject:inSortedRange:options:usingComparator:', {'arguments': {5: {'callable': {'retval': {'type': sel32or64(b'i', b'q')}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSOrderedSet', b'indexOfObjectAtIndexes:options:passingTest:', {'arguments': {4: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSOrderedSet', b'indexOfObjectPassingTest:', {'arguments': {2: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSOrderedSet', b'indexOfObjectWithOptions:passingTest:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSOrderedSet', b'indexesOfObjecstWithOptions:passingTest:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSOrderedSet', b'indexesOfObjectsAtIndexes:options:passingTest:', {'arguments': {4: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSOrderedSet', b'indexesOfObjectsPassingTest:', {'arguments': {2: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSOrderedSet', b'indexesOfObjectsWithOptions:passingTest:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSOrderedSet', b'initWithArray:copyItems:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSOrderedSet', b'initWithArray:range:copyItems:', {'arguments': {4: {'type': 'Z'}}})
    ...
    r(b'NSOrderedSet', b'initWithOrderedSet:copyItems:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSOrderedSet', b'initWithOrderedSet:range:copyItems:', {'arguments': {4: {'type': 'Z'}}})
    ...
    r(b'NSOrderedSet', b'orderedSetWithArray:copyItems:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSOrderedSet', b'orderedSetWithArray:range:copyItems:', {'arguments': {4: {'type': 'Z'}}})
    ...
    r(b'NSOrderedSet', b'orderedSetWithOrderedSet:copyItems:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSOrderedSet', b'orderedSetWithOrderedSet:range:copyItems:', {'arguments': {4: {'type': 'Z'}}})
    r(b'NSOrderedSet', b'orderedSetWithSet:copyItems:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSOrderedSet', b'sortedArrayUsingComparator:', {'arguments': {2: {'callable': {'retval': {'type': sel32or64(b'i', b'q')}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSOrderedSet', b'sortedArrayWithOptions:usingComparator:', {'arguments': {3: {'callable': {'retval': {'type': sel32or64(b'i', b'q')}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSOutputStream', b'hasSpaceAvailable', {'retval': {'type': 'Z'}})
    r(b'NSOutputStream', b'initToBuffer:capacity:', {'arguments': {2: {'type': '^v', 'type_modifier': b'o', 'c_array_length_in_arg': 3}}})
    ...
    r(b'NSOutputStream', b'outputStreamToBuffer:capacity:', {'arguments': {2: {'type': '^v', 'type_modifier': b'o', 'c_array_length_in_arg': 3}}})
    r(b'NSOutputStream', b'outputStreamToFileAtPath:append:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSOutputStream', b'outputStreamWithURL:append:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSOutputStream', b'write:maxLength:', {'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 3}}})
    r(b'NSPersonNameComponentsFormatter', b'getObjectValue:forString:errorDescription:', {'retval': {'type': 'Z'}, 'arguments': {2: {'null_accepted': False, 'type_modifier': b'o'}, 4: {'type_modifier': b'o'}}})
    r(b'NSPersonNameComponentsFormatter', b'isPhonetic', {'retval': {'type': 'Z'}})
    r(b'NSPersonNameComponentsFormatter', b'setPhonetic:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSPointerArray', b'addPointer:', {'arguments': {2: {'type': '@'}}, 'suggestion': 'use NSMutableArray'})
    r(b'NSPointerArray', b'insertPointer:atIndex:', {'arguments': {2: {'type': '@'}}, 'suggestion': 'use NSMutableArray'})
    r(b'NSPointerArray', b'pointerAtIndex:', {'retval': {'type': '@'}, 'suggestion': 'use NSMutableArray'})
    ...
    r(b'NSPointerFunctions', b'setUsesStrongWriteBarrier:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSPointerFunctions', b'setUsesWeakReadAndWriteBarriers:', {'arguments': {2: {'type': 'Z'}}})
    ...
    r(b'NSPort', b'sendBeforeDate:msgid:components:from:reserved:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSPredicate', b'evaluateWithObject:substitutionVariables:', {'retval': {'type': 'Z'}})
    r(b'NSPredicate', b'predicateWithBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSPredicate', b'predicateWithFormat:', {'arguments': {2: {'printf_format': True, 'type': '@'}}, 'variadic': True})
    r(b'NSPredicate', b'predicateWithFormat:arguments:', {'suggestion': 'use +predicateWithFormat:'})
    ...
    r(b'NSProcessInfo', b'isOperatingSystemAtLeastVersion:', {'retval': {'type': b'Z'}, 'arguments': {2: {'type': sel32or64(b'{_NSOperatingSystemVersion=iii}', b'{_NSOperatingSystemVersion=qqq}')}}})
    r(b'NSProcessInfo', b'operatingSystemVersion', {'retval': {'type': sel32or64(b'{_NSOperatingSystemVersion=iii}', b'{_NSOperatingSystemVersion=qqq}')}})
    r(b'NSProcessInfo', b'performActivityWithOptions:reason:usingBlock:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'NSProcessInfo', b'setAutomaticTerminationSupportEnabled:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSProgress', b'addSubscriberForFileURL:withPublishingHandler:', {'arguments': {3: {'callable': {'retval': {'callable': {'retval': {'type': 'v'}, 'arguments': {0: {'type': '^v'}}}, 'type': b'@?'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}, 'type': '@?'}}})
    r(b'NSProgress', b'cancellationHandler', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}})
    ...
    r(b'NSProgress', b'pausingHandler', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}})
    r(b'NSProgress', b'performAsCurrentWithPendingUnitCount:usingBlock:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'NSProgress', b'resumingHandler', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}})
    r(b'NSProgress', b'setCancellable:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSProgress', b'setCancellationHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'NSProgress', b'setPausable:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSProgress', b'setPausingHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'NSProgress', b'setResumingHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    ...
    r(b'NSProxy', b'respondsToSelector:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': ':'}}})
    ...
    r(b'NSRegularExpression', b'enumerateMatchesInString:options:range:usingBlock:', {'arguments': {5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    ...
    r(b'NSRunLoop', b'cancelPerformSelector:target:argument:', {'arguments': {2: {'type': ':', 'sel_of_type': b'v@:@'}}})
    r(b'NSRunLoop', b'performBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'NSRunLoop', b'performInModes:block:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    ...
    r(b'NSScanner', b'scanDecimal:', {'retval': {'type': 'Z'}, 'arguments': {2: {'null_accepted': False, 'type': b'^{_NSDecimal=b8b4b1b1b18[8S]}', 'type_modifier': b'o'}}})
    ...
    r(b'NSScanner', b'scanHexFloat:', {'retval': {'type': 'Z'}, 'arguments': {2: {'null_accepted': False, 'type': '^f', 'type_modifier': b'o'}}})
    r(b'NSScanner', b'scanHexInt:', {'retval': {'type': 'Z'}, 'arguments': {2: {'null_accepted': False, 'type_modifier': b'o'}}})
    r(b'NSScanner', b'scanHexLongLong:', {'retval': {'type': 'Z'}, 'arguments': {2: {'null_accepted': False, 'type': '^Q', 'type_modifier': b'o'}}})
    r(b'NSScanner', b'scanInt:', {'retval': {'type': 'Z'}, 'arguments': {2: {'null_accepted': False, 'type_modifier': b'o'}}})
    r(b'NSScanner', b'scanInteger:', {'retval': {'type': 'Z'}, 'arguments': {2: {'null_accepted': False, 'type_modifier': b'o'}}})
    r(b'NSScanner', b'scanLongLong:', {'retval': {'type': 'Z'}, 'arguments': {2: {'null_accepted': False, 'type_modifier': b'o'}}})
    r(b'NSScanner', b'scanString:intoString:', {'retval': {'type': 'Z'}, 'arguments': {3: {'null_accepted': False, 'type_modifier': b'o'}}})
    r(b'NSScanner', b'scanUnsignedLongLong:', {'retval': {'type': 'Z'}, 'arguments': {2: {'null_accepted': False, 'type_modifier': b'o'}}})
    r(b'NSScanner', b'scanUpToCharactersFromSet:intoString:', {'retval': {'type': 'Z'}, 'arguments': {3: {'null_accepted': False, 'type_modifier': b'o'}}})
    r(b'NSScanner', b'scanUpToString:intoString:', {'retval': {'type': 'Z'}, 'arguments': {3: {'null_accepted': False, 'type_modifier': b'o'}}})
    r(b'NSScanner', b'setCaseSensitive:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSScriptClassDescription', b'hasOrderedToManyRelationshipForKey:', {'retval': {'type': 'Z'}})
    r(b'NSScriptClassDescription', b'hasPropertyForKey:', {'retval': {'type': 'Z'}})
    r(b'NSScriptClassDescription', b'hasReadablePropertyForKey:', {'retval': {'type': 'Z'}})
    r(b'NSScriptClassDescription', b'hasWritablePropertyForKey:', {'retval': {'type': 'Z'}})
    r(b'NSScriptClassDescription', b'isLocationRequiredToCreateForKey:', {'retval': {'type': 'Z'}})
    ...
    r(b'NSScriptCommandDescription', b'isOptionalArgumentWithName:', {'retval': {'type': 'Z'}})
    r(b'NSScriptObjectSpecifier', b'containerIsObjectBeingTested', {'retval': {'type': 'Z'}})
    r(b'NSScriptObjectSpecifier', b'containerIsRangeContainerObject', {'retval': {'type': 'Z'}})
    ...
    r(b'NSScriptObjectSpecifier', b'setContainerIsObjectBeingTested:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSScriptObjectSpecifier', b'setContainerIsRangeContainerObject:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSScriptWhoseTest', b'isTrue', {'retval': {'type': 'Z'}})
    r(b'NSSet', b'addObserver:forKeyPath:options:context:', {'arguments': {5: {'type': '^v'}}})
    r(b'NSSet', b'containsObject:', {'retval': {'type': 'Z'}})
    r(b'NSSet', b'enumerateObjectsUsingBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSSet', b'enumerateObjectsWithOptions:usingBlock:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    ...
    r(b'NSSet', b'objectsPassingTest:', {'arguments': {2: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSSet', b'objectsWithOptions:passingTest:', {'arguments': {3: {'callable': {'retval': {'type': b'Z'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    ...
    r(b'NSSocketPortNameServer', b'registerPort:name:nameServerPortNumber:', {'retval': {'type': 'Z'}})
    r(b'NSSocketPortNameServer', b'removePortForName:', {'retval': {'type': 'Z'}})
    r(b'NSSortDescriptor', b'ascending', {'retval': {'type': 'Z'}})
    r(b'NSSortDescriptor', b'comparator', {'retval': {'callable': {'retval': {'type': b'i'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}})
    r(b'NSSortDescriptor', b'initWithKey:ascending:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSSortDescriptor', b'initWithKey:ascending:comparator:', {'arguments': {3: {'type': 'Z'}, 4: {'callable': {'retval': {'type': b'i'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSSortDescriptor', b'initWithKey:ascending:selector:', {'arguments': {3: {'type': 'Z'}, 4: {'sel_of_type': b'i@:@'}}})
    r(b'NSSortDescriptor', b'sortDescriptorWithKey:ascending:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSSortDescriptor', b'sortDescriptorWithKey:ascending:comparator:', {'arguments': {3: {'type': 'Z'}, 4: {'callable': {'retval': {'type': b'i'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSSortDescriptor', b'sortDescriptorWithKey:ascending:selector:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSSpellServer', b'isWordInUserDictionaries:caseSensitive:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': 'Z'}}})
    r(b'NSSpellServer', b'registerLanguage:byVendor:', {'retval': {'type': 'Z'}})
    r(b'NSStream', b'getBoundStreamsWithBufferSize:inputStream:outputStream:', {'arguments': {3: {'type_modifier': b'o'}, 4: {'type_modifier': b'o'}}})
    ...
    r(b'NSStream', b'getStreamsToHostWithName:port:inputStream:outputStream:', {'arguments': {4: {'type_modifier': b'o'}, 5: {'type_modifier': b'o'}}})
    r(b'NSStream', b'setProperty:forKey:', {'retval': {'type': 'Z'}})
    r(b'NSString', b'', {'retval': {'type': '*'}})
    r(b'NSString', b'UTF8String', {'retval': {'c_array_delimited_by_null': True, 'type': '^t'}})
    r(b'NSString', b'availableStringEncodings', {'retval': {'c_array_delimited_by_null': True, 'type': sel32or64(b'r^I', b'r^Q')}})
    r(b'NSString', b'boolValue', {'retval': {'type': 'Z'}})
    r(b'NSString', b'cString', {'retval': {'c_array_delimited_by_null': True, 'type': '^t'}})
    r(b'NSString', b'cStringUsingEncoding:', {'retval': {'c_array_delimited_by_null': True, 'type': '^v'}})
    ...
    r(b'NSString', b'completePathIntoString:caseSensitive:matchesIntoArray:filterTypes:', {'arguments': {2: {'type_modifier': b'o'}, 3: {'type': 'Z'}, 4: {'type_modifier': b'o'}}})
    r(b'NSString', b'containsString:', {'retval': {'type': b'Z'}})
    r(b'NSString', b'dataUsingEncoding:allowLossyConversion:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSString', b'enumerateLinesUsingBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSString', b'enumerateLinguisticTagsInRange:scheme:options:orthography:usingBlock:', {'arguments': {6: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 3: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 4: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSString', b'enumerateSubstringsInRange:options:usingBlock:', {'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 3: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 4: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSString', b'enumeratorLinguisticTagsInRange:scheme:options:orthography:usingBlock:', {'arguments': {6: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 3: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}, 4: {'type': b'^Z', 'type_modifier': 'o'}}}}}})
    r(b'NSString', b'fileSystemRepresentation', {'retval': {'c_array_delimited_by_null': True, 'type': '^t'}})
    ...
    r(b'NSString', b'getCString:', {'arguments': {2: {'type': '*'}}, 'suggestion': 'use -cString'})
    r(b'NSString', b'getCString:maxLength:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': '^v', 'type_modifier': b'o', 'c_array_length_in_arg': 3}}, 'suggestion': 'use -cString instead'})
    r(b'NSString', b'getCString:maxLength:encoding:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': '^v', 'type_modifier': b'o', 'c_array_length_in_arg': 3}}, 'suggestion': 'use -cString instead'})
    r(b'NSString', b'getCString:maxLength:range:remainingRange:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': '^v', 'type_modifier': b'o', 'c_array_length_in_arg': 3}, 5: {'type': sel32or64(b'^{_NSRange=II}', b'^{_NSRange=QQ}'), 'type_modifier': b'o'}}, 'suggestion': 'use -cString instead'})
    r(b'NSString', b'getCharacters:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': '^T', 'type_modifier': b'o', 'c_array_of_variable_length': True}}})
    r(b'NSString', b'getCharacters:range:', {'retval': {'type': 'v'}, 'arguments': {2: {'type': '^T', 'type_modifier': b'o', 'c_array_length_in_arg': 3}, 3: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSString', b'getFileSystemRepresentation:maxLength:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': '^t', 'type_modifier': b'o', 'c_array_length_in_arg': 3}}})
    r(b'NSString', b'getLineStart:end:contentsEnd:forRange:', {'retval': {'type': 'v'}, 'arguments': {2: {'type_modifier': b'o'}, 3: {'type_modifier': b'o'}, 4: {'type_modifier': b'o'}, 5: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSString', b'getParagraphStart:end:contentsEnd:forRange:', {'retval': {'type': 'v'}, 'arguments': {2: {'type_modifier': b'o'}, 3: {'type_modifier': b'o'}, 4: {'type_modifier': b'o'}, 5: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    ...
    r(b'NSString', b'initWithBytesNoCopy:length:encoding:freeWhenDone:', {'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 5: {'type': 'Z'}}, 'suggestion': 'use -initWithBytes:length:encoding instead'})
    r(b'NSString', b'initWithCString:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type': '^v', 'type_modifier': b'n'}}})
    r(b'NSString', b'initWithCString:encoding:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type': '^t', 'type_modifier': b'n'}}})
    r(b'NSString', b'initWithCString:length:', {'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 3}}})
    r(b'NSString', b'initWithCStringNoCopy:length:freeWhenDone:', {'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 4: {'type': 'Z'}}, 'suggestion': 'use -initWithCString:length: instead'})
    r(b'NSString', b'initWithCharacters:length:', {'arguments': {2: {'type': '^T', 'type_modifier': b'n', 'c_array_length_in_arg': 3}}})
    r(b'NSString', b'initWithCharactersNoCopy:length:freeWhenDone:', {'retval': {'type': '@'}, 'arguments': {2: {'type': '^T', 'type_modifier': b'n', 'c_array_length_in_arg': 3}, 4: {'type': 'Z'}}, 'suggestion': 'use -initWithCharacters:length: instead'})
    r(b'NSString', b'initWithContentsOfFile:encoding:error:', {'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSString', b'initWithContentsOfFile:usedEncoding:error:', {'arguments': {3: {'type': sel32or64(b'r^I', b'r^Q'), 'type_modifier': b'o'}, 4: {'type_modifier': b'o'}}})
    ...
    r(b'NSString', b'initWithContentsOfURL:usedEncoding:error:', {'arguments': {3: {'type': sel32or64(b'r^I', b'r^Q'), 'type_modifier': b'o'}, 4: {'type_modifier': b'o'}}})
    r(b'NSString', b'initWithFormat:', {'arguments': {2: {'printf_format': True, 'type': '@'}}, 'variadic': True})
    r(b'NSString', b'initWithFormat:arguments:', {'arguments': {3: {'type': sel32or64(b'*', b'[1{?=II^v^v}]')}}, 'suggestion': 'use -initWithFormat:'})
    r(b'NSString', b'initWithFormat:locale:', {'arguments': {2: {'printf_format': True, 'type': '@'}}, 'variadic': True})
    r(b'NSString', b'initWithFormat:locale:arguments:', {'arguments': {4: {'type': sel32or64(b'*', b'[1{?=II^v^v}]')}}, 'suggestion': 'use -initWithFormat:locale:'})
    r(b'NSString', b'initWithUTF8String:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type': '^t', 'type_modifier': b'n'}}})
    ...
    r(b'NSString', b'localizedStringWithFormat:', {'arguments': {2: {'printf_format': True, 'type': '@'}}, 'variadic': True})
    r(b'NSString', b'lossyCString', {'retval': {'c_array_delimited_by_null': True, 'type': '^t'}})
    ...
    r(b'NSString', b'stringByAppendingFormat:', {'arguments': {2: {'printf_format': True, 'type': '@'}}, 'variadic': True})
    r(b'NSString', b'stringByApplyingTransform:reverse:', {'arguments': {3: {'type': 'Z'}}})
    ...
    r(b'NSString', b'stringEncodingForData:encodingOptions:convertedString:usedLossyConversion:', {'arguments': {4: {'type_modifier': b'o'}, 5: {'type': b'^Z', 'type_modifier': b'o'}}})
    r(b'NSString', b'stringWithCString:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type': '^v', 'type_modifier': b'n'}}})
    r(b'NSString', b'stringWithCString:encoding:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type': '^t', 'type_modifier': b'n'}}})
    r(b'NSString', b'stringWithCString:length:', {'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_length_in_arg': 3}}})
    r(b'NSString', b'stringWithCharacters:length:', {'arguments': {2: {'type': 'r^T', 'type_modifier': b'n', 'c_array_length_in_arg': 3}}})
    r(b'NSString', b'stringWithContentsOfFile:encoding:error:', {'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSString', b'stringWithContentsOfFile:usedEncoding:error:', {'arguments': {3: {'type': sel32or64(b'r^I', b'r^Q'), 'type_modifier': b'o'}, 4: {'type_modifier': b'o'}}})
    r(b'NSString', b'stringWithContentsOfURL:encoding:error:', {'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSString', b'stringWithContentsOfURL:usedEncoding:error:', {'arguments': {3: {'type': sel32or64(b'r^I', b'r^Q'), 'type_modifier': b'o'}, 4: {'type_modifier': b'o'}}})
    r(b'NSString', b'stringWithFormat:', {'arguments': {2: {'printf_format': True, 'type': '@'}}, 'variadic': True})
    r(b'NSString', b'stringWithUTF8String:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type': '^t', 'type_modifier': b'n'}}})
    r(b'NSString', b'substringWithRange:', {'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSString', b'writeToFile:atomically:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': 'Z'}}})
    r(b'NSString', b'writeToFile:atomically:encoding:error:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': 'Z'}, 5: {'type_modifier': b'o'}}})
    r(b'NSString', b'writeToURL:atomically:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': 'Z'}}})
    r(b'NSString', b'writeToURL:atomically:encoding:error:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type': 'Z'}, 5: {'type_modifier': b'o'}}})
    r(b'NSTask', b'isRunning', {'retval': {'type': 'Z'}})
    r(b'NSTask', b'launchedTaskWithExecutableURL:arguments:error:terminationHandler:', {'arguments': {4: {'type_modifier': b'o'}, 5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSTask', b'resume', {'retval': {'type': 'Z'}})
    r(b'NSTask', b'setTerminationHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSTask', b'suspend', {'retval': {'type': 'Z'}})
    r(b'NSTask', b'terminationHandler', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}})
    ...
    r(b'NSTextCheckingResult', b'phoneNumberCheckingResultWithRange:phoneNumber:', {'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    ...
    r(b'NSTextCheckingResult', b'regularExpressionCheckingResultWithRanges:count:regularExpression:', {'arguments': {2: {'type': sel32or64(b'^{_NSRange=II}', b'^{_NSRange=QQ}'), 'type_modifier': b'n', 'c_array_length_in_arg': 3}}})
    ...
    r(b'NSTextCheckingResult', b'transitInformationCheckingResultWithRange:components:', {'arguments': {2: {'type': sel32or64(b'{_NSRange=II}', b'{_NSRange=QQ}')}}})
    r(b'NSThread', b'detachNewThreadSelector:toTarget:withObject:', {'arguments': {2: {'sel_of_type': b'v@:@'}}})
    r(b'NSThread', b'detachNewThreadWithBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'NSThread', b'initWithBlock:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    ...
    r(b'NSTimer', b'initWithFireDate:interval:repeats:block:', {'arguments': {4: {'type': 'Z'}, 5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSTimer', b'initWithFireDate:interval:target:selector:userInfo:repeats:', {'arguments': {5: {'sel_of_type': b'v@:@'}, 7: {'type': 'Z'}}})
    r(b'NSTimer', b'isValid', {'retval': {'type': 'Z'}})
    r(b'NSTimer', b'scheduledTimerWithTimeInterval:invocation:repeats:', {'arguments': {4: {'type': 'Z'}}})
    r(b'NSTimer', b'scheduledTimerWithTimeInterval:repeats:block:', {'arguments': {3: {'type': 'Z'}, 4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSTimer', b'scheduledTimerWithTimeInterval:target:selector:userInfo:repeats:', {'arguments': {4: {'sel_of_type': b'v@:@'}, 6: {'type': 'Z'}}})
    r(b'NSTimer', b'timerWithTimeInterval:invocation:repeats:', {'arguments': {4: {'type': 'Z'}}})
    r(b'NSTimer', b'timerWithTimeInterval:repeats:block:', {'arguments': {3: {'type': 'Z'}, 4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSTimer', b'timerWithTimeInterval:target:selector:userInfo:repeats:', {'arguments': {4: {'sel_of_type': b'v@:@'}, 6: {'type': 'Z'}}})
    r(b'NSURL', b'URLByAppendingPathComponent:isDirectory:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSURL', b'URLByResolvingAliasFileAtURL:options:error:', {'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSURL', b'URLByResolvingBookmarkData:options:relativeToURL:bookmarkDataIsStale:error:', {'arguments': {5: {'type': '^Z', 'type_modifier': b'o'}, 6: {'type_modifier': b'o'}}})
    ...
    r(b'NSURL', b'checkPromisedItemIsReachableAndReturnError:', {'retval': {'type': b'Z'}, 'arguments': {2: {'type_modifier': b'o'}}})
    r(b'NSURL', b'checkResourceIsReachableAndReturnError:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type_modifier': b'o'}}})
    r(b'NSURL', b'fileURLWithFileSystemRepresentation:isDirectory:relativeToURL:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type_modifier': b'n'}, 3: {'type': 'Z'}}})
    r(b'NSURL', b'fileURLWithPath:isDirectory:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSURL', b'fileURLWithPath:isDirectory:relativeToURL:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSURL', b'getFileSystemRepresentation:maxLength:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type': '^t', 'type_modifier': b'o', 'c_array_length_in_arg': 3}}})
    r(b'NSURL', b'getPromisedItemResourceValue:forKey:error:', {'retval': {'type': b'Z'}})
    r(b'NSURL', b'getResourceValue:forKey:error:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type_modifier': b'o'}, 4: {'type_modifier': b'o'}}})
    r(b'NSURL', b'hasDirectoryPath', {'retval': {'type': 'Z'}})
    r(b'NSURL', b'initByResolvingBookmarkData:options:relativeToURL:bookmarkDataIsStale:error:', {'arguments': {5: {'type': '^Z', 'type_modifier': b'o'}, 6: {'type_modifier': b'o'}}})
    r(b'NSURL', b'initFileURLWithFileSystemRepresentation:isDirectory:relativeToURL:', {'arguments': {2: {'c_array_delimited_by_null': True, 'type_modifier': b'n'}, 3: {'type': 'Z'}}})
    r(b'NSURL', b'initFileURLWithPath:isDirectory:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSURL', b'initFileURLWithPath:isDirectory:relativeToURL:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSURL', b'initWithContentsOfURL:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSURL', b'isFileReferenceURL', {'retval': {'type': 'Z'}})
    r(b'NSURL', b'isFileURL', {'retval': {'type': 'Z'}})
    r(b'NSURL', b'loadResourceDataNotifyingClient:usingCache:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSURL', b'promisedItemResourceValuesForKeys:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    ...
    r(b'NSURL', b'setResourceValue:forKey:error:', {'retval': {'type': 'Z'}, 'arguments': {4: {'type_modifier': b'o'}}})
    r(b'NSURL', b'setResourceValues:error:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSURL', b'startAccessingSecurityScopedResource', {'retval': {'type': b'Z'}})
    r(b'NSURL', b'writeBookmarkData:toURL:options:error:', {'retval': {'type': 'Z'}, 'arguments': {5: {'type_modifier': b'o'}}})
    r(b'NSURL', b'writeToURL:error:', {'retval': {'type': 'Z'}, 'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSURLCache', b'getCachedResponseForDataTask:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSURLComponents', b'componentsWithURL:resolvingAgainstBaseURL:', {'arguments': {3: {'type': b'Z'}}})
    r(b'NSURLComponents', b'initWithURL:resolvingAgainstBaseURL:', {'arguments': {3: {'type': b'Z'}}})
    r(b'NSURLConnection', b'canHandleRequest:', {'retval': {'type': 'Z'}})
    r(b'NSURLConnection', b'initWithRequest:delegate:startImmediately:', {'arguments': {4: {'type': 'Z'}}})
    r(b'NSURLConnection', b'sendAsynchronousRequest:queue:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    ...
    r(b'NSURLCredentialStorage', b'getCredentialsForProtectionSpace:task:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSURLCredentialStorage', b'getDefaultCredentialForProtectionSpace:task:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSURLDownload', b'canResumeDownloadDecodedWithEncodingMIMEType:', {'retval': {'type': 'Z'}})
    r(b'NSURLDownload', b'deletesFileUponFailure', {'retval': {'type': 'Z'}})
    r(b'NSURLDownload', b'setDeletesFileUponFailure:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSURLDownload', b'setDestination:allowOverwrite:', {'arguments': {3: {'type': 'Z'}}})
    ...
    r(b'NSURLSession', b'dataTaskWithRequest:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}}}})
    r(b'NSURLSession', b'dataTaskWithURL:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}}}})
    r(b'NSURLSession', b'downloadTaskWithResumeData:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}}}})
    r(b'NSURLSession', b'downloadTaskWithURL:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}}}})
    r(b'NSURLSession', b'flushWithCompletionHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'NSURLSession', b'getAllTasksWithCompletionHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSURLSession', b'getTasksWithCompletionHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}}}})
    r(b'NSURLSession', b'resetWithCompletionHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'NSURLSession', b'uploadTaskWithRequest:fromData:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}}}})
    r(b'NSURLSession', b'uploadTaskWithRequest:fromFile:completionHandler:', {'arguments': {4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}}}})
    r(b'NSURLSessionConfiguration', b'HTTPShouldSetCookies', {'retval': {'type': b'Z'}})
    r(b'NSURLSessionConfiguration', b'HTTPShouldUsePipelining', {'retval': {'type': b'Z'}})
    ...
    r(b'NSURLSessionConfiguration', b'sessionSendsLaunchEvents', {'retval': {'type': b'Z'}})
    r(b'NSURLSessionConfiguration', b'setAllowsCellularAccess:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSURLSessionConfiguration', b'setDiscretionary:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSURLSessionConfiguration', b'setHTTPShouldSetCookies:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSURLSessionConfiguration', b'setHTTPShouldUsePipelining:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSURLSessionConfiguration', b'setSessionSendsLaunchEvents:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSURLSessionConfiguration', b'setShouldUseExtendedBackgroundIdleMode:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSURLSessionConfiguration', b'setWaitsForConnectivity:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSURLSessionConfiguration', b'shouldUseExtendedBackgroundIdleMode', {'retval': {'type': 'Z'}})
    r(b'NSURLSessionConfiguration', b'waitsForConnectivity', {'retval': {'type': 'Z'}})
    r(b'NSURLSessionDownloadTask', b'cancelByProducingResumeData:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSURLSessionStreamTask', b'readDataOfMinLength:maxLength:timeout:completionHandler:', {'arguments': {2: {'type': sel32or64(b'I', b'Q')}, 3: {'type': sel32or64(b'I', b'Q')}, 4: {'type': sel32or64(b'f', b'd')}, 5: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'Z'}, 3: {'type': b'@'}}}, 'type': '@?'}}})
    r(b'NSURLSessionStreamTask', b'writeData:timeout:completionHandler:', {'arguments': {3: {'type': sel32or64(b'f', b'd')}, 4: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}, 'type': '@?'}}})
    r(b'NSURLSessionTaskTransactionMetrics', b'isProxyConnection', {'retval': {'type': 'Z'}})
    r(b'NSURLSessionTaskTransactionMetrics', b'isReusedConnection', {'retval': {'type': 'Z'}})
    ...
    r(b'NSUndoManager', b'redoMenuTitleForUndoActionName:', {'arguments': {2: {'type': '@'}}})
    r(b'NSUndoManager', b'registerUndoWithTarget:handler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    ...
    r(b'NSUserActivity', b'getContinuationStreamsWithCompletionHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}, 3: {'type': b'@'}}}, 'type': '@?'}}})
    ...
    r(b'NSUserActivity', b'setEligibleForPublicIndexing:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSUserActivity', b'setEligibleForSearch:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSUserActivity', b'setNeedsSave:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSUserActivity', b'setSupportsContinuationStreams:', {'arguments': {2: {'type': b'Z'}}})
    r(b'NSUserActivity', b'supportsContinuationStreams', {'retval': {'type': b'Z'}})
    r(b'NSUserAppleScriptTask', b'executeWithAppleEvent:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}, 2: {'type': b'@'}}}}}})
    r(b'NSUserAutomatorTask', b'executeWithInput:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'@'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    ...
    r(b'NSUserScriptTask', b'executeWithCompletionHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSUserScriptTask', b'initWithURL:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSUserUnixTask', b'executeWithArguments:completionHandler:', {'arguments': {3: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSValue', b'getValue:', {'arguments': {2: {'type': '^v'}}, 'suggestion': 'use another method'})
    r(b'NSValue', b'initWithBytes:objCType:', {'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_of_variable_length': True}, 3: {'c_array_delimited_by_null': True, 'type': '^t', 'type_modifier': b'n'}}, 'suggestion': 'use something else'})
    r(b'NSValue', b'isEqualToValue:', {'retval': {'type': 'Z'}})
    r(b'NSValue', b'objCType', {'retval': {'c_array_delimited_by_null': True, 'type': '^t'}})
    r(b'NSValue', b'pointValue', {'retval': {'type': sel32or64(b'{_NSPoint=ff}', b'{CGPoint=dd}')}})
    r(b'NSValue', b'pointerValue', {'retval': {'type': '^v'}, 'suggestion': 'use something else'})
    ...
    r(b'NSValue', b'value:withObjCType:', {'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_of_variable_length': True}, 3: {'c_array_delimited_by_null': True, 'type': '^t', 'type_modifier': b'n'}}, 'suggestion': 'use something else'})
    r(b'NSValue', b'valueWithBytes:objCType:', {'arguments': {2: {'type': '^v', 'type_modifier': b'n', 'c_array_of_variable_length': True}, 3: {'c_array_delimited_by_null': True, 'type': '^t', 'type_modifier': b'n'}}, 'suggestion': 'use something else'})
    r(b'NSValue', b'valueWithPoint:', {'arguments': {2: {'type': sel32or64(b'{_NSPoint=ff}', b'{CGPoint=dd}')}}})
    r(b'NSValue', b'valueWithPointer:', {'arguments': {2: {'type': '^v'}}, 'suggestion': 'use some other method'})
    ...
    r(b'NSXMLDocument', b'validateAndReturnError:', {'retval': {'type': 'Z'}, 'arguments': {2: {'type_modifier': b'o'}}})
    r(b'NSXMLElement', b'initWithXMLString:error:', {'arguments': {3: {'type_modifier': b'o'}}})
    r(b'NSXMLElement', b'normalizeAdjacentTextNodesPreservingCDATA:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSXMLNode', b'canonicalXMLStringPreservingComments:', {'arguments': {2: {'type': 'Z'}}})
    ...
    r(b'NSXMLNode', b'setStringValue:resolvingEntities:', {'arguments': {3: {'type': 'Z'}}})
    r(b'NSXMLParser', b'parse', {'retval': {'type': 'Z'}})
    r(b'NSXMLParser', b'setShouldProcessNamespaces:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSXMLParser', b'setShouldReportNamespacePrefixes:', {'arguments': {2: {'type': 'Z'}}})
    r(b'NSXMLParser', b'setShouldResolveExternalEntities:', {'arguments': {2: {'type': 'Z'}}})
    ...
    r(b'NSXPCConnection', b'interruptionHandler', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}})
    r(b'NSXPCConnection', b'invalidationHandler', {'retval': {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}})
    r(b'NSXPCConnection', b'setInterruptionHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'NSXPCConnection', b'setInvalidationHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}}}}}})
    r(b'NSXPCConnection', b'synchronousRemoteObjectProxyWithErrorHandler:', {'arguments': {2: {'callable': {'retval': {'type': b'v'}, 'arguments': {0: {'type': b'^v'}, 1: {'type': b'@'}}}}}})
    r(b'NSXPCInterface', b'classesForSelector:argumentIndex:ofReply:', {'arguments': {4: {'type': b'Z'}}})
    r(b'NSXPCInterface', b'interfaceForSelector:argumentIndex:ofReply:', {'arguments': {4: {'type': b'Z'}}})
    r(b'NSXPCInterface', b'setClasses:forSelector:argumentIndex:ofReply:', {'arguments': {5: {'type': b'Z'}}})
    r(b'NSXPCInterface', b'setInterface:forSelector:argumentIndex:ofReply:', {'arguments': {5: {'type': b'Z'}}})
finally:
...
expressions = {'NSAppleEventSendDefaultOptions': 'NSAppleEventSendWaitForReply | NSAppleEventSendCanInteract'}
